...
func (o *NDSAuditViewForNdsGroup) Created() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *NDSAuditViewForNdsGroup) EventTypeName() NDSAuditTypeViewForNdsGroup {
	if o == nil {
...
func (o *NDSAuditViewForNdsGroup) Id() string {
	if o == nil {
		var ret string
		return ret
	}
