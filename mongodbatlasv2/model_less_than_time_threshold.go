...
// checks if the LessThanTimeThreshold type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LessThanTimeThreshold{}

// LessThanTimeThreshold A Limit that triggers an alert when less than a time period.
type LessThanTimeThreshold struct {
...
func (o *LessThanTimeThreshold) GetThreshold() int32 {
...
// and a boolean to check if the value has been set.
func (o *LessThanTimeThreshold) GetThresholdOk() (*int32, bool) {
	if o == nil || IsNil(o.Threshold) {
		return nil, false
	}
...
func (o *LessThanTimeThreshold) SetThreshold(v int32) {
	o.Threshold = &v
}
...
type NullableLessThanTimeThreshold struct {
	value *LessThanTimeThreshold
	isSet bool
}

func (v NullableLessThanTimeThreshold) Get() *LessThanTimeThreshold {
	return v.value
}

func (v *NullableLessThanTimeThreshold) Set(val *LessThanTimeThreshold) {
	v.value = val
	v.isSet = true
}

func (v NullableLessThanTimeThreshold) IsSet() bool {
	return v.isSet
}

func (v *NullableLessThanTimeThreshold) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLessThanTimeThreshold(val *LessThanTimeThreshold) *NullableLessThanTimeThreshold {
	return &NullableLessThanTimeThreshold{value: val, isSet: true}
}

func (v NullableLessThanTimeThreshold) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLessThanTimeThreshold) UnmarshalJSON(src []byte) error {
	v.isSet = true
