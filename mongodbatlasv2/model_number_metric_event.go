...
// checks if the NumberMetricEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NumberMetricEvent{}

// NumberMetricEvent struct for NumberMetricEvent
type NumberMetricEvent struct {
...
func (o *NumberMetricEvent) Created() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *NumberMetricEvent) EventTypeName() HostMetricEventType {
	if o == nil {
...
func (o *NumberMetricEvent) Id() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *NumberMetricEvent) SetIsGlobalAdmin(v bool) {
	o.IsGlobalAdmin = &v
}
...
func (o *NumberMetricEvent) GetPort() int32 {
...
// and a boolean to check if the value has been set.
func (o *NumberMetricEvent) GetPortOk() (*int32, bool) {
	if o == nil || IsNil(o.Port) {
		return nil, false
	}
	return o.Port, true
...
func (o *NumberMetricEvent) SetPort(v int32) {
	o.Port = &v
}
...
type NullableNumberMetricEvent struct {
	value *NumberMetricEvent
	isSet bool
}

func (v NullableNumberMetricEvent) Get() *NumberMetricEvent {
	return v.value
}

func (v *NullableNumberMetricEvent) Set(val *NumberMetricEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableNumberMetricEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableNumberMetricEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNumberMetricEvent(val *NumberMetricEvent) *NullableNumberMetricEvent {
	return &NullableNumberMetricEvent{value: val, isSet: true}
}

func (v NullableNumberMetricEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNumberMetricEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
