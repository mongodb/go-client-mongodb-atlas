...
type IndexOptions struct {
	...
	Var2dsphereIndexVersion *int32 `json:"2dsphereIndexVersion,omitempty"`
...
// SetVar2dsphereIndexVersion gets a reference to the given int32 and assigns it to the Var2dsphereIndexVersion field.
