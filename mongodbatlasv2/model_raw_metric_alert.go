...
// checks if the RawMetricAlert type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RawMetricAlert{}

// RawMetricAlert struct for RawMetricAlert
type RawMetricAlert struct {
...
func (o *RawMetricAlert) AcknowledgedUntil() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *RawMetricAlert) AlertConfigId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *RawMetricAlert) Created() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *RawMetricAlert) EventTypeName() HostMetricEventTypeViewAlertable {
	if o == nil {
...
func (o *RawMetricAlert) Id() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *RawMetricAlert) Status() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *RawMetricAlert) Updated() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
type NullableRawMetricAlert struct {
	value *RawMetricAlert
	isSet bool
}

func (v NullableRawMetricAlert) Get() *RawMetricAlert {
	return v.value
}

func (v *NullableRawMetricAlert) Set(val *RawMetricAlert) {
	v.value = val
	v.isSet = true
}

func (v NullableRawMetricAlert) IsSet() bool {
	return v.isSet
}

func (v *NullableRawMetricAlert) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRawMetricAlert(val *RawMetricAlert) *NullableRawMetricAlert {
	return &NullableRawMetricAlert{value: val, isSet: true}
}

func (v NullableRawMetricAlert) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRawMetricAlert) UnmarshalJSON(src []byte) error {
	v.isSet = true
