...
// checks if the PagerDutyNotification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PagerDutyNotification{}

// PagerDutyNotification PagerDuty notification configuration for MongoDB Cloud to send information when an event triggers an alert condition.
...
func (o *PagerDutyNotification) GetDelayMin() int32 {
...
func (o *PagerDutyNotification) GetDelayMinOk() (*int32, bool) {
	if o == nil || IsNil(o.DelayMin) {
		return nil, false
	}
...
func (o *PagerDutyNotification) SetDelayMin(v int32) {
	o.DelayMin = &v
}

// GetIntervalMin returns the IntervalMin field value if set, zero value otherwise.
func (o *PagerDutyNotification) GetIntervalMin() int32 {
...
// and a boolean to check if the value has been set.
func (o *PagerDutyNotification) GetIntervalMinOk() (*int32, bool) {
	if o == nil || IsNil(o.IntervalMin) {
		return nil, false
	}
...
func (o *PagerDutyNotification) SetIntervalMin(v int32) {
	o.IntervalMin = &v
}
...
type NullablePagerDutyNotification struct {
	value *PagerDutyNotification
	isSet bool
}

func (v NullablePagerDutyNotification) Get() *PagerDutyNotification {
	return v.value
}

func (v *NullablePagerDutyNotification) Set(val *PagerDutyNotification) {
	v.value = val
	v.isSet = true
}

func (v NullablePagerDutyNotification) IsSet() bool {
	return v.isSet
}

func (v *NullablePagerDutyNotification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePagerDutyNotification(val *PagerDutyNotification) *NullablePagerDutyNotification {
	return &NullablePagerDutyNotification{value: val, isSet: true}
}

func (v NullablePagerDutyNotification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePagerDutyNotification) UnmarshalJSON(src []byte) error {
	v.isSet = true
