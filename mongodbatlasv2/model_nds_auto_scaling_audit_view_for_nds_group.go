...
// checks if the NDSAutoScalingAuditViewForNdsGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NDSAutoScalingAuditViewForNdsGroup{}

// NDSAutoScalingAuditViewForNdsGroup NDS auto scaling audit indicates when atlas auto-scaling cluster tier up or down.
type NDSAutoScalingAuditViewForNdsGroup struct {
	...
	EventTypeName NDSAutoScalingAuditTypeViewForNdsGroup `json:"eventTypeName"`
...
func (o *NDSAutoScalingAuditViewForNdsGroup) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
type NullableNDSAutoScalingAuditViewForNdsGroup struct {
	value *NDSAutoScalingAuditViewForNdsGroup
	isSet bool
}

func (v NullableNDSAutoScalingAuditViewForNdsGroup) Get() *NDSAutoScalingAuditViewForNdsGroup {
	return v.value
}

func (v *NullableNDSAutoScalingAuditViewForNdsGroup) Set(val *NDSAutoScalingAuditViewForNdsGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableNDSAutoScalingAuditViewForNdsGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableNDSAutoScalingAuditViewForNdsGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNDSAutoScalingAuditViewForNdsGroup(val *NDSAutoScalingAuditViewForNdsGroup) *NullableNDSAutoScalingAuditViewForNdsGroup {
	return &NullableNDSAutoScalingAuditViewForNdsGroup{value: val, isSet: true}
}

func (v NullableNDSAutoScalingAuditViewForNdsGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNDSAutoScalingAuditViewForNdsGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
