...
// checks if the UserEventViewForOrg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserEventViewForOrg{}
...
func (o *UserEventViewForOrg) Created() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *UserEventViewForOrg) EventTypeName() UserEventTypeViewForOrg {
	if o == nil {
...
func (o *UserEventViewForOrg) Id() string {
	if o == nil {
		var ret string
		return ret
	}
