...
func (o *ApiUserEventViewForOrg) Created() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *ApiUserEventViewForOrg) EventTypeName() UserEventTypeViewForOrg {
	if o == nil {
...
func (o *ApiUserEventViewForOrg) Id() string {
	if o == nil {
		var ret string
		return ret
	}
