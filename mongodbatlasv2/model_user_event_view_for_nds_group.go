...
func (o *UserEventViewForNdsGroup) Created() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *UserEventViewForNdsGroup) EventTypeName() UserEventTypeViewForNdsGroup {
	if o == nil {
...
func (o *UserEventViewForNdsGroup) Id() string {
	if o == nil {
		var ret string
		return ret
	}
