...
// Number of items that the response returns per page.
func (r ListExportBucketsApiRequest) ItemsPerPage(itemsPerPage int32) ListExportBucketsApiRequest {
	r.itemsPerPage = &itemsPerPage
	return r
}

// Number of the page that displays the current set of the total objects that the response returns.
func (r ListExportBucketsApiRequest) PageNum(pageNum int32) ListExportBucketsApiRequest {
	r.pageNum = &pageNum
	return r
}
...
// Number of items that the response returns per page.
func (r ListServerlessBackupRestoreJobsApiRequest) ItemsPerPage(itemsPerPage int32) ListServerlessBackupRestoreJobsApiRequest {
	r.itemsPerPage = &itemsPerPage
	return r
}

// Number of the page that displays the current set of the total objects that the response returns.
func (r ListServerlessBackupRestoreJobsApiRequest) PageNum(pageNum int32) ListServerlessBackupRestoreJobsApiRequest {
	r.pageNum = &pageNum
	return r
}
