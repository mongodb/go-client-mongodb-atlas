...
func (o *ApiUserEventViewForNdsGroup) Created() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *ApiUserEventViewForNdsGroup) EventTypeName() UserEventTypeViewForNdsGroup {
	if o == nil {
...
func (o *ApiUserEventViewForNdsGroup) Id() string {
	if o == nil {
		var ret string
		return ret
	}
