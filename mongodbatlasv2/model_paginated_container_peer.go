...
func (o *PaginatedContainerPeer) GetTotalCount() int32 {
...
// and a boolean to check if the value has been set.
func (o *PaginatedContainerPeer) GetTotalCountOk() (*int32, bool) {
	if o == nil || IsNil(o.TotalCount) {
		return nil, false
	}
...
func (o *PaginatedContainerPeer) SetTotalCount(v int32) {
	o.TotalCount = &v
}
