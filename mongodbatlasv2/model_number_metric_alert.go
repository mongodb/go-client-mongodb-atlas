...
// checks if the NumberMetricAlert type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NumberMetricAlert{}

// NumberMetricAlert struct for NumberMetricAlert
type NumberMetricAlert struct {
...
type NullableNumberMetricAlert struct {
	value *NumberMetricAlert
	isSet bool
}

func (v NullableNumberMetricAlert) Get() *NumberMetricAlert {
	return v.value
}

func (v *NullableNumberMetricAlert) Set(val *NumberMetricAlert) {
	v.value = val
	v.isSet = true
}

func (v NullableNumberMetricAlert) IsSet() bool {
	return v.isSet
}

func (v *NullableNumberMetricAlert) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNumberMetricAlert(val *NumberMetricAlert) *NullableNumberMetricAlert {
	return &NullableNumberMetricAlert{value: val, isSet: true}
}

func (v NullableNumberMetricAlert) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNumberMetricAlert) UnmarshalJSON(src []byte) error {
	v.isSet = true
