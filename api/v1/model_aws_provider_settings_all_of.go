...
// AWSProviderSettingsAllOf struct for AWSProviderSettingsAllOf
type AWSProviderSettingsAllOf struct {
...
// NewAWSProviderSettingsAllOf instantiates a new AWSProviderSettingsAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAWSProviderSettingsAllOf() *AWSProviderSettingsAllOf {
	this := AWSProviderSettingsAllOf{}
	var encryptEBSVolume bool = true
	this.EncryptEBSVolume = &encryptEBSVolume
	return &this
}

// NewAWSProviderSettingsAllOfWithDefaults instantiates a new AWSProviderSettingsAllOf object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAWSProviderSettingsAllOfWithDefaults() *AWSProviderSettingsAllOf {
	this := AWSProviderSettingsAllOf{}
	var encryptEBSVolume bool = true
	this.EncryptEBSVolume = &encryptEBSVolume
	return &this
...
func (o *AWSProviderSettingsAllOf) GetAutoScaling() AWSAutoScaling {
...
func (o *AWSProviderSettingsAllOf) GetAutoScalingOk() (*AWSAutoScaling, bool) {
	if o == nil || o.AutoScaling == nil {
		return nil, false
	}
...
func (o *AWSProviderSettingsAllOf) HasAutoScaling() bool {
	if o != nil && o.AutoScaling != nil {
		return true
	}
...
func (o *AWSProviderSettingsAllOf) SetAutoScaling(v AWSAutoScaling) {
	o.AutoScaling = &v
}

// GetDiskIOPS returns the DiskIOPS field value if set, zero value otherwise.
func (o *AWSProviderSettingsAllOf) GetDiskIOPS() int32 {
...
// and a boolean to check if the value has been set.
func (o *AWSProviderSettingsAllOf) GetDiskIOPSOk() (*int32, bool) {
	if o == nil || o.DiskIOPS == nil {
		return nil, false
	}
...
func (o *AWSProviderSettingsAllOf) HasDiskIOPS() bool {
	if o != nil && o.DiskIOPS != nil {
		return true
	}
...
func (o *AWSProviderSettingsAllOf) SetDiskIOPS(v int32) {
	o.DiskIOPS = &v
}

// GetEncryptEBSVolume returns the EncryptEBSVolume field value if set, zero value otherwise.
// Deprecated
func (o *AWSProviderSettingsAllOf) GetEncryptEBSVolume() bool {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *AWSProviderSettingsAllOf) GetEncryptEBSVolumeOk() (*bool, bool) {
	if o == nil || o.EncryptEBSVolume == nil {
		return nil, false
	}
...
func (o *AWSProviderSettingsAllOf) HasEncryptEBSVolume() bool {
	if o != nil && o.EncryptEBSVolume != nil {
		return true
	}
...
// Deprecated
func (o *AWSProviderSettingsAllOf) SetEncryptEBSVolume(v bool) {
	o.EncryptEBSVolume = &v
}

// GetInstanceSizeName returns the InstanceSizeName field value if set, zero value otherwise.
func (o *AWSProviderSettingsAllOf) GetInstanceSizeName() string {
...
// and a boolean to check if the value has been set.
func (o *AWSProviderSettingsAllOf) GetInstanceSizeNameOk() (*string, bool) {
	if o == nil || o.InstanceSizeName == nil {
		return nil, false
	}
...
func (o *AWSProviderSettingsAllOf) HasInstanceSizeName() bool {
	if o != nil && o.InstanceSizeName != nil {
		return true
	}
...
func (o *AWSProviderSettingsAllOf) SetInstanceSizeName(v string) {
	o.InstanceSizeName = &v
}

// GetRegionName returns the RegionName field value if set, zero value otherwise.
func (o *AWSProviderSettingsAllOf) GetRegionName() string {
...
// and a boolean to check if the value has been set.
func (o *AWSProviderSettingsAllOf) GetRegionNameOk() (*string, bool) {
	if o == nil || o.RegionName == nil {
		return nil, false
	}
...
func (o *AWSProviderSettingsAllOf) HasRegionName() bool {
	if o != nil && o.RegionName != nil {
		return true
	}
...
func (o *AWSProviderSettingsAllOf) SetRegionName(v string) {
	o.RegionName = &v
}

// GetVolumeType returns the VolumeType field value if set, zero value otherwise.
func (o *AWSProviderSettingsAllOf) GetVolumeType() string {
...
// and a boolean to check if the value has been set.
func (o *AWSProviderSettingsAllOf) GetVolumeTypeOk() (*string, bool) {
	if o == nil || o.VolumeType == nil {
		return nil, false
	}
...
func (o *AWSProviderSettingsAllOf) HasVolumeType() bool {
	if o != nil && o.VolumeType != nil {
		return true
	}
...
func (o *AWSProviderSettingsAllOf) SetVolumeType(v string) {
	o.VolumeType = &v
}

func (o AWSProviderSettingsAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAWSProviderSettingsAllOf struct {
	value *AWSProviderSettingsAllOf
	isSet bool
}

func (v NullableAWSProviderSettingsAllOf) Get() *AWSProviderSettingsAllOf {
	return v.value
}

func (v *NullableAWSProviderSettingsAllOf) Set(val *AWSProviderSettingsAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAWSProviderSettingsAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAWSProviderSettingsAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAWSProviderSettingsAllOf(val *AWSProviderSettingsAllOf) *NullableAWSProviderSettingsAllOf {
	return &NullableAWSProviderSettingsAllOf{value: val, isSet: true}
}

func (v NullableAWSProviderSettingsAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAWSProviderSettingsAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
