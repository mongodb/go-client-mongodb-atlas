...
func (o *TimeMetricAlertView) GetEventTypeName() HostMetricAlertableEventType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetEventTypeNameOk() (*HostMetricAlertableEventType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TimeMetricAlertView) SetEventTypeName(v HostMetricAlertableEventType) {
	o.EventTypeName = v
}
