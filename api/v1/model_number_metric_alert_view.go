...
func (o *NumberMetricAlertView) GetEventTypeName() HostMetricAlertableEventType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *NumberMetricAlertView) GetEventTypeNameOk() (*HostMetricAlertableEventType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NumberMetricAlertView) SetEventTypeName(v HostMetricAlertableEventType) {
	o.EventTypeName = v
}
