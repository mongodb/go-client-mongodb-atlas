...
type HostEventViewForNdsGroup struct {
	...
	EventTypeName HostEventTypeForNdsGroup `json:"eventTypeName"`
...
func NewHostEventViewForNdsGroup() *HostEventViewForNdsGroup {
...
func (o *HostEventViewForNdsGroup) GetEventTypeName() HostEventTypeForNdsGroup {
	if o == nil {
		var ret HostEventTypeForNdsGroup
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *HostEventViewForNdsGroup) GetEventTypeNameOk() (*HostEventTypeForNdsGroup, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HostEventViewForNdsGroup) SetEventTypeName(v HostEventTypeForNdsGroup) {
	o.EventTypeName = v
}
