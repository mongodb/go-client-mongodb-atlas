...
func (o *RawMetricAlertView) GetEventTypeName() HostMetricAlertableEventType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *RawMetricAlertView) GetEventTypeNameOk() (*HostMetricAlertableEventType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RawMetricAlertView) SetEventTypeName(v HostMetricAlertableEventType) {
	o.EventTypeName = v
}
