...
type NullableApiPolicyItemView struct {
	value *ApiPolicyItemView
	isSet bool
}

func (v NullableApiPolicyItemView) Get() *ApiPolicyItemView {
	return v.value
}

func (v *NullableApiPolicyItemView) Set(val *ApiPolicyItemView) {
	v.value = val
	v.isSet = true
}

func (v NullableApiPolicyItemView) IsSet() bool {
	return v.isSet
}

func (v *NullableApiPolicyItemView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiPolicyItemView(val *ApiPolicyItemView) *NullableApiPolicyItemView {
	return &NullableApiPolicyItemView{value: val, isSet: true}
}

func (v NullableApiPolicyItemView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiPolicyItemView) UnmarshalJSON(src []byte) error {
	v.isSet = true
