...
type ReplicaSetAlertViewForNdsGroup struct {
	...
	EventTypeName ReplicaSetAlertableEventTypeForNdsGroup `json:"eventTypeName"`
...
func NewReplicaSetAlertViewForNdsGroup() *ReplicaSetAlertViewForNdsGroup {
...
func (o *ReplicaSetAlertViewForNdsGroup) GetEventTypeName() ReplicaSetAlertableEventTypeForNdsGroup {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ReplicaSetAlertViewForNdsGroup) GetEventTypeNameOk() (*ReplicaSetAlertableEventTypeForNdsGroup, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ReplicaSetAlertViewForNdsGroup) SetEventTypeName(v ReplicaSetAlertableEventTypeForNdsGroup) {
	o.EventTypeName = v
}
