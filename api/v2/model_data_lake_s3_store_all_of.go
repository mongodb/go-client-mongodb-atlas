...
// DataLakeS3StoreAllOf struct for DataLakeS3StoreAllOf
type DataLakeS3StoreAllOf struct {
...
// NewDataLakeS3StoreAllOf instantiates a new DataLakeS3StoreAllOf object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDataLakeS3StoreAllOf() *DataLakeS3StoreAllOf {
	this := DataLakeS3StoreAllOf{}
...
// NewDataLakeS3StoreAllOfWithDefaults instantiates a new DataLakeS3StoreAllOf object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDataLakeS3StoreAllOfWithDefaults() *DataLakeS3StoreAllOf {
	this := DataLakeS3StoreAllOf{}
	var includeTags bool = false
	this.IncludeTags = &includeTags
	var public bool = false
...
func (o *DataLakeS3StoreAllOf) GetAdditionalStorageClasses() []string {
...
func (o *DataLakeS3StoreAllOf) GetAdditionalStorageClassesOk() ([]string, bool) {
	if o == nil || o.AdditionalStorageClasses == nil {
		return nil, false
	}
...
func (o *DataLakeS3StoreAllOf) HasAdditionalStorageClasses() bool {
	if o != nil && o.AdditionalStorageClasses != nil {
		return true
	}
...
func (o *DataLakeS3StoreAllOf) SetAdditionalStorageClasses(v []string) {
	o.AdditionalStorageClasses = v
}

// GetBucket returns the Bucket field value if set, zero value otherwise.
func (o *DataLakeS3StoreAllOf) GetBucket() string {
...
// and a boolean to check if the value has been set.
func (o *DataLakeS3StoreAllOf) GetBucketOk() (*string, bool) {
	if o == nil || o.Bucket == nil {
		return nil, false
	}
...
func (o *DataLakeS3StoreAllOf) HasBucket() bool {
	if o != nil && o.Bucket != nil {
		return true
	}
...
func (o *DataLakeS3StoreAllOf) SetBucket(v string) {
	o.Bucket = &v
}

// GetDelimiter returns the Delimiter field value if set, zero value otherwise.
func (o *DataLakeS3StoreAllOf) GetDelimiter() string {
...
// and a boolean to check if the value has been set.
func (o *DataLakeS3StoreAllOf) GetDelimiterOk() (*string, bool) {
	if o == nil || o.Delimiter == nil {
		return nil, false
	}
...
func (o *DataLakeS3StoreAllOf) HasDelimiter() bool {
	if o != nil && o.Delimiter != nil {
		return true
	}
...
func (o *DataLakeS3StoreAllOf) SetDelimiter(v string) {
	o.Delimiter = &v
}

// GetIncludeTags returns the IncludeTags field value if set, zero value otherwise.
func (o *DataLakeS3StoreAllOf) GetIncludeTags() bool {
...
// and a boolean to check if the value has been set.
func (o *DataLakeS3StoreAllOf) GetIncludeTagsOk() (*bool, bool) {
	if o == nil || o.IncludeTags == nil {
		return nil, false
	}
...
func (o *DataLakeS3StoreAllOf) HasIncludeTags() bool {
	if o != nil && o.IncludeTags != nil {
		return true
	}
...
func (o *DataLakeS3StoreAllOf) SetIncludeTags(v bool) {
	o.IncludeTags = &v
}

// GetPrefix returns the Prefix field value if set, zero value otherwise.
func (o *DataLakeS3StoreAllOf) GetPrefix() string {
...
// and a boolean to check if the value has been set.
func (o *DataLakeS3StoreAllOf) GetPrefixOk() (*string, bool) {
	if o == nil || o.Prefix == nil {
		return nil, false
	}
...
func (o *DataLakeS3StoreAllOf) HasPrefix() bool {
	if o != nil && o.Prefix != nil {
		return true
	}
...
func (o *DataLakeS3StoreAllOf) SetPrefix(v string) {
	o.Prefix = &v
}

// GetPublic returns the Public field value if set, zero value otherwise.
func (o *DataLakeS3StoreAllOf) GetPublic() bool {
...
// and a boolean to check if the value has been set.
func (o *DataLakeS3StoreAllOf) GetPublicOk() (*bool, bool) {
	if o == nil || o.Public == nil {
		return nil, false
	}
...
func (o *DataLakeS3StoreAllOf) HasPublic() bool {
	if o != nil && o.Public != nil {
		return true
	}
...
func (o *DataLakeS3StoreAllOf) SetPublic(v bool) {
	o.Public = &v
}

// GetRegion returns the Region field value if set, zero value otherwise.
func (o *DataLakeS3StoreAllOf) GetRegion() string {
...
// and a boolean to check if the value has been set.
func (o *DataLakeS3StoreAllOf) GetRegionOk() (*string, bool) {
	if o == nil || o.Region == nil {
		return nil, false
	}
...
func (o *DataLakeS3StoreAllOf) HasRegion() bool {
	if o != nil && o.Region != nil {
		return true
	}
...
func (o *DataLakeS3StoreAllOf) SetRegion(v string) {
	o.Region = &v
}

func (o DataLakeS3StoreAllOf) MarshalJSON() ([]byte, error) {
...
type NullableDataLakeS3StoreAllOf struct {
	value *DataLakeS3StoreAllOf
	isSet bool
}

func (v NullableDataLakeS3StoreAllOf) Get() *DataLakeS3StoreAllOf {
	return v.value
}

func (v *NullableDataLakeS3StoreAllOf) Set(val *DataLakeS3StoreAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableDataLakeS3StoreAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableDataLakeS3StoreAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDataLakeS3StoreAllOf(val *DataLakeS3StoreAllOf) *NullableDataLakeS3StoreAllOf {
	return &NullableDataLakeS3StoreAllOf{value: val, isSet: true}
}

func (v NullableDataLakeS3StoreAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDataLakeS3StoreAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
