...
// AppServiceMetricAlertConfigViewForNdsGroup App Service metric alert configuration allows to select which app service metrics trigger alerts and how users are notified.
