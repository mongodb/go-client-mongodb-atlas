...
// checks if the DateCriteriaViewAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DateCriteriaViewAllOf{}
...
func (o DateCriteriaViewAllOf) ToMap() (map[string]interface{}, error) {
