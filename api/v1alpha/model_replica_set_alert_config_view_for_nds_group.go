...
type ReplicaSetAlertConfigViewForNdsGroup struct {
	...
	EventTypeName ReplicaSetEventTypeViewForNdsGroupAlertableNoThreshold `json:"eventTypeName"`
...
func NewReplicaSetAlertConfigViewForNdsGroup() *ReplicaSetAlertConfigViewForNdsGroup {
	this := ReplicaSetAlertConfigViewForNdsGroup{}
...
type NullableReplicaSetAlertConfigViewForNdsGroup struct {
	value *ReplicaSetAlertConfigViewForNdsGroup
	isSet bool
}

func (v NullableReplicaSetAlertConfigViewForNdsGroup) Get() *ReplicaSetAlertConfigViewForNdsGroup {
	return v.value
}

func (v *NullableReplicaSetAlertConfigViewForNdsGroup) Set(val *ReplicaSetAlertConfigViewForNdsGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableReplicaSetAlertConfigViewForNdsGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableReplicaSetAlertConfigViewForNdsGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReplicaSetAlertConfigViewForNdsGroup(val *ReplicaSetAlertConfigViewForNdsGroup) *NullableReplicaSetAlertConfigViewForNdsGroup {
	return &NullableReplicaSetAlertConfigViewForNdsGroup{value: val, isSet: true}
}

func (v NullableReplicaSetAlertConfigViewForNdsGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReplicaSetAlertConfigViewForNdsGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
