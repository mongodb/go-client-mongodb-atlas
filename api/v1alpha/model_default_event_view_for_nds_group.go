...
// DefaultEventViewForNdsGroup Other events which don't have extra details beside of basic one.
type DefaultEventViewForNdsGroup struct {
	...
	EventTypeName DefaultEventViewForNdsGroupEventTypeName `json:"eventTypeName"`
...
func NewDefaultEventViewForNdsGroup() *DefaultEventViewForNdsGroup {
	this := DefaultEventViewForNdsGroup{}
	return &this
}
...
func (o *DefaultEventViewForNdsGroup) GetEventTypeName() DefaultEventViewForNdsGroupEventTypeName {
	if o == nil {
		var ret DefaultEventViewForNdsGroupEventTypeName
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DefaultEventViewForNdsGroup) GetEventTypeNameOk() (*DefaultEventViewForNdsGroupEventTypeName, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DefaultEventViewForNdsGroup) SetEventTypeName(v DefaultEventViewForNdsGroupEventTypeName) {
	o.EventTypeName = v
}
...
func (o *DefaultEventViewForNdsGroup) SetId(v string) {
	o.Id = v
}
...
func (o *DefaultEventViewForNdsGroup) GetOrgId() string {
...
func (o *DefaultEventViewForNdsGroup) SetUserId(v string) {
	o.UserId = &v
}
...
type NullableDefaultEventViewForNdsGroup struct {
	value *DefaultEventViewForNdsGroup
	isSet bool
}

func (v NullableDefaultEventViewForNdsGroup) Get() *DefaultEventViewForNdsGroup {
	return v.value
}

func (v *NullableDefaultEventViewForNdsGroup) Set(val *DefaultEventViewForNdsGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableDefaultEventViewForNdsGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableDefaultEventViewForNdsGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDefaultEventViewForNdsGroup(val *DefaultEventViewForNdsGroup) *NullableDefaultEventViewForNdsGroup {
	return &NullableDefaultEventViewForNdsGroup{value: val, isSet: true}
}

func (v NullableDefaultEventViewForNdsGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDefaultEventViewForNdsGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
