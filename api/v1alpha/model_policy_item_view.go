...
// checks if the PolicyItemView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyItemView{}

// PolicyItemView Specifications for one policy.
...
// NewPolicyItemView instantiates a new PolicyItemView object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPolicyItemView(frequencyInterval int32, frequencyType string, retentionUnit string, retentionValue int32) *PolicyItemView {
	this := PolicyItemView{}
...
// NewPolicyItemViewWithDefaults instantiates a new PolicyItemView object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPolicyItemViewWithDefaults() *PolicyItemView {
	this := PolicyItemView{}
	return &this
}

// GetFrequencyInterval returns the FrequencyInterval field value
func (o *PolicyItemView) GetFrequencyInterval() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *PolicyItemView) GetFrequencyIntervalOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PolicyItemView) SetFrequencyInterval(v int32) {
	o.FrequencyInterval = v
}

// GetFrequencyType returns the FrequencyType field value
func (o *PolicyItemView) GetFrequencyType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PolicyItemView) GetFrequencyTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PolicyItemView) SetFrequencyType(v string) {
	o.FrequencyType = v
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *PolicyItemView) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PolicyItemView) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PolicyItemView) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PolicyItemView) SetId(v string) {
	o.Id = &v
}

// GetRetentionUnit returns the RetentionUnit field value
func (o *PolicyItemView) GetRetentionUnit() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PolicyItemView) GetRetentionUnitOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PolicyItemView) SetRetentionUnit(v string) {
	o.RetentionUnit = v
}

// GetRetentionValue returns the RetentionValue field value
func (o *PolicyItemView) GetRetentionValue() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PolicyItemView) GetRetentionValueOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PolicyItemView) SetRetentionValue(v int32) {
	o.RetentionValue = v
}

func (o PolicyItemView) MarshalJSON() ([]byte, error) {
...
func (o PolicyItemView) ToMap() (map[string]interface{}, error) {
...
type NullablePolicyItemView struct {
	value *PolicyItemView
	isSet bool
}

func (v NullablePolicyItemView) Get() *PolicyItemView {
	return v.value
}

func (v *NullablePolicyItemView) Set(val *PolicyItemView) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyItemView) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyItemView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyItemView(val *PolicyItemView) *NullablePolicyItemView {
	return &NullablePolicyItemView{value: val, isSet: true}
}

func (v NullablePolicyItemView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyItemView) UnmarshalJSON(src []byte) error {
	v.isSet = true
