...
// AppServiceAlertView App Services alert notifies different activities about a BAAS application.
...
// NewAppServiceAlertView instantiates a new AppServiceAlertView object
...
// NewAppServiceAlertViewWithDefaults instantiates a new AppServiceAlertView object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAppServiceAlertViewWithDefaults() *AppServiceAlertView {
	this := AppServiceAlertView{}
	return &this
}

// GetAcknowledgedUntil returns the AcknowledgedUntil field value
func (o *AppServiceAlertView) GetAcknowledgedUntil() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *AppServiceAlertView) GetAcknowledgedUntilOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AppServiceAlertView) SetAcknowledgedUntil(v time.Time) {
...
func (o *AppServiceAlertView) SetAcknowledgementComment(v string) {
...
func (o *AppServiceAlertView) SetAcknowledgingUsername(v string) {
	o.AcknowledgingUsername = &v
}

// GetAlertConfigId returns the AlertConfigId field value
func (o *AppServiceAlertView) GetAlertConfigId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AppServiceAlertView) GetAlertConfigIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AppServiceAlertView) SetAlertConfigId(v string) {
	o.AlertConfigId = v
}

// GetCreated returns the Created field value
func (o *AppServiceAlertView) GetCreated() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AppServiceAlertView) GetCreatedOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AppServiceAlertView) SetCreated(v time.Time) {
	o.Created = v
}

// GetEventTypeName returns the EventTypeName field value
func (o *AppServiceAlertView) GetEventTypeName() AppServiceEventTypeViewAlertable {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *AppServiceAlertView) GetEventTypeNameOk() (*AppServiceEventTypeViewAlertable, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AppServiceAlertView) SetEventTypeName(v AppServiceEventTypeViewAlertable) {
	o.EventTypeName = v
}
...
func (o *AppServiceAlertView) SetGroupId(v string) {
	o.GroupId = &v
}

// GetId returns the Id field value
func (o *AppServiceAlertView) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AppServiceAlertView) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *AppServiceAlertView) SetId(v string) {
	o.Id = v
}
...
func (o *AppServiceAlertView) SetLastNotified(v time.Time) {
	o.LastNotified = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *AppServiceAlertView) GetLinks() []Link {
...
// and a boolean to check if the value has been set.
func (o *AppServiceAlertView) GetLinksOk() ([]Link, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *AppServiceAlertView) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
func (o *AppServiceAlertView) SetLinks(v []Link) {
	o.Links = v
}
...
func (o *AppServiceAlertView) SetOrgId(v string) {
	o.OrgId = &v
}
...
func (o *AppServiceAlertView) SetResolved(v time.Time) {
	o.Resolved = &v
}

// GetStatus returns the Status field value
func (o *AppServiceAlertView) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AppServiceAlertView) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AppServiceAlertView) SetStatus(v string) {
	o.Status = v
}

// GetUpdated returns the Updated field value
func (o *AppServiceAlertView) GetUpdated() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AppServiceAlertView) GetUpdatedOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AppServiceAlertView) SetUpdated(v time.Time) {
	o.Updated = v
}
...
type NullableAppServiceAlertView struct {
	value *AppServiceAlertView
	isSet bool
}

func (v NullableAppServiceAlertView) Get() *AppServiceAlertView {
	return v.value
}

func (v *NullableAppServiceAlertView) Set(val *AppServiceAlertView) {
	v.value = val
	v.isSet = true
}

func (v NullableAppServiceAlertView) IsSet() bool {
	return v.isSet
}

func (v *NullableAppServiceAlertView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppServiceAlertView(val *AppServiceAlertView) *NullableAppServiceAlertView {
	return &NullableAppServiceAlertView{value: val, isSet: true}
}

func (v NullableAppServiceAlertView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppServiceAlertView) UnmarshalJSON(src []byte) error {
	v.isSet = true
