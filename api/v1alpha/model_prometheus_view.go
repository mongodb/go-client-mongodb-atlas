...
// checks if the PrometheusView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrometheusView{}

// PrometheusView Details to integrate one Prometheus account with one MongoDB Cloud project.
...
// NewPrometheusView instantiates a new PrometheusView object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPrometheusView(enabled bool, scheme string, serviceDiscovery string, username string) *PrometheusView {
	this := PrometheusView{}
...
// NewPrometheusViewWithDefaults instantiates a new PrometheusView object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPrometheusViewWithDefaults() *PrometheusView {
	this := PrometheusView{}
	var listenAddress string = ":9216"
	this.ListenAddress = &listenAddress
	return &this
...
func (o *PrometheusView) GetEnabled() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *PrometheusView) GetEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PrometheusView) SetEnabled(v bool) {
	o.Enabled = v
}

// GetListenAddress returns the ListenAddress field value if set, zero value otherwise.
func (o *PrometheusView) GetListenAddress() string {
...
// and a boolean to check if the value has been set.
func (o *PrometheusView) GetListenAddressOk() (*string, bool) {
	if o == nil || IsNil(o.ListenAddress) {
		return nil, false
	}
...
func (o *PrometheusView) HasListenAddress() bool {
	if o != nil && !IsNil(o.ListenAddress) {
		return true
	}
...
func (o *PrometheusView) SetListenAddress(v string) {
	o.ListenAddress = &v
}

// GetPassword returns the Password field value if set, zero value otherwise.
func (o *PrometheusView) GetPassword() string {
...
// and a boolean to check if the value has been set.
func (o *PrometheusView) GetPasswordOk() (*string, bool) {
	if o == nil || IsNil(o.Password) {
		return nil, false
	}
...
func (o *PrometheusView) HasPassword() bool {
	if o != nil && !IsNil(o.Password) {
		return true
	}
...
func (o *PrometheusView) SetPassword(v string) {
	o.Password = &v
}

// GetRateLimitInterval returns the RateLimitInterval field value if set, zero value otherwise.
func (o *PrometheusView) GetRateLimitInterval() int32 {
...
// and a boolean to check if the value has been set.
func (o *PrometheusView) GetRateLimitIntervalOk() (*int32, bool) {
	if o == nil || IsNil(o.RateLimitInterval) {
		return nil, false
	}
...
func (o *PrometheusView) HasRateLimitInterval() bool {
	if o != nil && !IsNil(o.RateLimitInterval) {
		return true
	}
...
func (o *PrometheusView) SetRateLimitInterval(v int32) {
	o.RateLimitInterval = &v
}

// GetScheme returns the Scheme field value
func (o *PrometheusView) GetScheme() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PrometheusView) GetSchemeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PrometheusView) SetScheme(v string) {
	o.Scheme = v
}

// GetServiceDiscovery returns the ServiceDiscovery field value
func (o *PrometheusView) GetServiceDiscovery() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PrometheusView) GetServiceDiscoveryOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *PrometheusView) GetTlsPemPathOk() (*string, bool) {
	if o == nil || IsNil(o.TlsPemPath) {
		return nil, false
	}
...
func (o *PrometheusView) HasTlsPemPath() bool {
	if o != nil && !IsNil(o.TlsPemPath) {
		return true
	}
...
func (o *PrometheusView) SetTlsPemPath(v string) {
	o.TlsPemPath = &v
}

// GetType returns the Type field value if set, zero value otherwise.
func (o *PrometheusView) GetType() string {
...
// and a boolean to check if the value has been set.
func (o *PrometheusView) GetTypeOk() (*string, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *PrometheusView) HasType() bool {
	if o != nil && !IsNil(o.Type) {
		return true
	}
...
func (o *PrometheusView) SetType(v string) {
	o.Type = &v
}

// GetUsername returns the Username field value
func (o *PrometheusView) GetUsername() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PrometheusView) GetUsernameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PrometheusView) SetUsername(v string) {
	o.Username = v
}

func (o PrometheusView) MarshalJSON() ([]byte, error) {
...
func (o PrometheusView) ToMap() (map[string]interface{}, error) {
...
type NullablePrometheusView struct {
	value *PrometheusView
	isSet bool
}

func (v NullablePrometheusView) Get() *PrometheusView {
	return v.value
}

func (v *NullablePrometheusView) Set(val *PrometheusView) {
	v.value = val
	v.isSet = true
}

func (v NullablePrometheusView) IsSet() bool {
	return v.isSet
}

func (v *NullablePrometheusView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrometheusView(val *PrometheusView) *NullablePrometheusView {
	return &NullablePrometheusView{value: val, isSet: true}
}

func (v NullablePrometheusView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrometheusView) UnmarshalJSON(src []byte) error {
	v.isSet = true
