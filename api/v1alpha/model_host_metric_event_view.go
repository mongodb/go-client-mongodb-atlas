...
func (o *HostMetricEventView) GetEventTypeName() HostMetricEventType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *HostMetricEventView) GetEventTypeNameOk() (*HostMetricEventType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HostMetricEventView) SetEventTypeName(v HostMetricEventType) {
	o.EventTypeName = v
}
