...
// checks if the PaginatedDiskPartitionView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedDiskPartitionView{}
...
func NewPaginatedDiskPartitionView() *PaginatedDiskPartitionView {
...
func (o *PaginatedDiskPartitionView) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
func (o *PaginatedDiskPartitionView) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
func (o *PaginatedDiskPartitionView) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o PaginatedDiskPartitionView) ToMap() (map[string]interface{}, error) {
