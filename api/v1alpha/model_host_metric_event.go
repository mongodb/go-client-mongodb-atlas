...
func DataMetricEventAsHostMetricEvent(v *DataMetricEvent) HostMetricEvent {
	return HostMetricEvent{
		DataMetricEvent: v,
	}
}

// NumberMetricEventAsHostMetricEvent is a convenience function that returns NumberMetricEvent wrapped in HostMetricEvent
func NumberMetricEventAsHostMetricEvent(v *NumberMetricEvent) HostMetricEvent {
	return HostMetricEvent{
		NumberMetricEvent: v,
	}
}

// RawMetricEventAsHostMetricEvent is a convenience function that returns RawMetricEvent wrapped in HostMetricEvent
func RawMetricEventAsHostMetricEvent(v *RawMetricEvent) HostMetricEvent {
	return HostMetricEvent{
		RawMetricEvent: v,
	}
}

// TimeMetricEventAsHostMetricEvent is a convenience function that returns TimeMetricEvent wrapped in HostMetricEvent
func TimeMetricEventAsHostMetricEvent(v *TimeMetricEvent) HostMetricEvent {
	return HostMetricEvent{
		TimeMetricEvent: v,
	}
}
...
func (dst *HostMetricEvent) UnmarshalJSON(data []byte) error {
	...
	if jsonDict["metricName"] == "ASSERT_MSG" {
		// try to unmarshal JSON data into RawMetricEvent
		err = json.Unmarshal(data, &dst.RawMetricEvent)
		if err == nil {
			return nil // data stored in dst.RawMetricEvent, return on the first match
		} else {
			dst.RawMetricEvent = nil
			return fmt.Errorf("failed to unmarshal HostMetricEvent as RawMetricEvent: %s", err.Error())
		}
	}
	...
	if jsonDict["metricName"] == "AVG_COMMAND_EXECUTION_TIME" {
		// try to unmarshal JSON data into TimeMetricEvent
		err = json.Unmarshal(data, &dst.TimeMetricEvent)
		if err == nil {
			return nil // data stored in dst.TimeMetricEvent, return on the first match
		} else {
			dst.TimeMetricEvent = nil
			return fmt.Errorf("failed to unmarshal HostMetricEvent as TimeMetricEvent: %s", err.Error())
		}
	}
	...
	if jsonDict["metricName"] == "CACHE_BYTES_READ_INTO" {
		// try to unmarshal JSON data into DataMetricEvent
		err = json.Unmarshal(data, &dst.DataMetricEvent)
		if err == nil {
			return nil // data stored in dst.DataMetricEvent, return on the first match
		} else {
			dst.DataMetricEvent = nil
			return fmt.Errorf("failed to unmarshal HostMetricEvent as DataMetricEvent: %s", err.Error())
		}
	}
	...
	// check if the discriminator value is 'DataMetricEvent'
	if jsonDict["metricName"] == "DataMetricEvent" {
		// try to unmarshal JSON data into DataMetricEvent
		err = json.Unmarshal(data, &dst.DataMetricEvent)
		if err == nil {
			return nil // data stored in dst.DataMetricEvent, return on the first match
	...
	// check if the discriminator value is 'NumberMetricEvent'
	if jsonDict["metricName"] == "NumberMetricEvent" {
		// try to unmarshal JSON data into NumberMetricEvent
		err = json.Unmarshal(data, &dst.NumberMetricEvent)
		if err == nil {
			return nil // data stored in dst.NumberMetricEvent, return on the first match
		} else {
			dst.NumberMetricEvent = nil
			return fmt.Errorf("failed to unmarshal HostMetricEvent as NumberMetricEvent: %s", err.Error())
		}
	}
	...
	// check if the discriminator value is 'RawMetricEvent'
	if jsonDict["metricName"] == "RawMetricEvent" {
		// try to unmarshal JSON data into RawMetricEvent
		err = json.Unmarshal(data, &dst.RawMetricEvent)
		if err == nil {
			return nil // data stored in dst.RawMetricEvent, return on the first match
	...
	// check if the discriminator value is 'TimeMetricEvent'
	if jsonDict["metricName"] == "TimeMetricEvent" {
		// try to unmarshal JSON data into TimeMetricEvent
		err = json.Unmarshal(data, &dst.TimeMetricEvent)
		if err == nil {
			return nil // data stored in dst.TimeMetricEvent, return on the first match
...
func (src HostMetricEvent) MarshalJSON() ([]byte, error) {
	if src.DataMetricEvent != nil {
		return json.Marshal(&src.DataMetricEvent)
	}

	if src.NumberMetricEvent != nil {
		return json.Marshal(&src.NumberMetricEvent)
	}

	if src.RawMetricEvent != nil {
		return json.Marshal(&src.RawMetricEvent)
	}

	if src.TimeMetricEvent != nil {
		return json.Marshal(&src.TimeMetricEvent)
	}
...
func (obj *HostMetricEvent) GetActualInstance() (interface{}) {
	...
	if obj.DataMetricEvent != nil {
		return obj.DataMetricEvent
	}

	if obj.NumberMetricEvent != nil {
		return obj.NumberMetricEvent
	}

	if obj.RawMetricEvent != nil {
		return obj.RawMetricEvent
	}

	if obj.TimeMetricEvent != nil {
		return obj.TimeMetricEvent
	}
...
type NullableHostMetricEvent struct {
	value *HostMetricEvent
	isSet bool
}

func (v NullableHostMetricEvent) Get() *HostMetricEvent {
	return v.value
}

func (v *NullableHostMetricEvent) Set(val *HostMetricEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableHostMetricEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableHostMetricEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostMetricEvent(val *HostMetricEvent) *NullableHostMetricEvent {
	return &NullableHostMetricEvent{value: val, isSet: true}
}

func (v NullableHostMetricEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostMetricEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
