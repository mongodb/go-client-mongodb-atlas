...
// checks if the OrgPaginatedEventView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrgPaginatedEventView{}
...
func (o *OrgPaginatedEventView) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
func (o OrgPaginatedEventView) ToMap() (map[string]interface{}, error) {
