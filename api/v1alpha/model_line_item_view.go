...
// checks if the LineItemView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LineItemView{}

// LineItemView One service included in this invoice.
...
// NewLineItemView instantiates a new LineItemView object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLineItemView() *LineItemView {
	this := LineItemView{}
	return &this
}

// NewLineItemViewWithDefaults instantiates a new LineItemView object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewLineItemViewWithDefaults() *LineItemView {
	this := LineItemView{}
	return &this
}

// GetClusterName returns the ClusterName field value if set, zero value otherwise.
func (o *LineItemView) GetClusterName() string {
...
func (o *LineItemView) GetClusterNameOk() (*string, bool) {
	if o == nil || IsNil(o.ClusterName) {
		return nil, false
	}
...
func (o *LineItemView) HasClusterName() bool {
	if o != nil && !IsNil(o.ClusterName) {
		return true
	}
...
func (o *LineItemView) SetClusterName(v string) {
	o.ClusterName = &v
}

// GetCreated returns the Created field value if set, zero value otherwise.
func (o *LineItemView) GetCreated() time.Time {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetCreatedOk() (*time.Time, bool) {
	if o == nil || IsNil(o.Created) {
		return nil, false
	}
...
func (o *LineItemView) HasCreated() bool {
	if o != nil && !IsNil(o.Created) {
		return true
	}
...
func (o *LineItemView) SetCreated(v time.Time) {
	o.Created = &v
}

// GetDiscountCents returns the DiscountCents field value if set, zero value otherwise.
func (o *LineItemView) GetDiscountCents() int64 {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetDiscountCentsOk() (*int64, bool) {
	if o == nil || IsNil(o.DiscountCents) {
		return nil, false
	}
...
func (o *LineItemView) HasDiscountCents() bool {
	if o != nil && !IsNil(o.DiscountCents) {
		return true
	}
...
func (o *LineItemView) SetDiscountCents(v int64) {
	o.DiscountCents = &v
}

// GetEndDate returns the EndDate field value if set, zero value otherwise.
func (o *LineItemView) GetEndDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetEndDateOk() (*time.Time, bool) {
	if o == nil || IsNil(o.EndDate) {
		return nil, false
	}
...
func (o *LineItemView) HasEndDate() bool {
	if o != nil && !IsNil(o.EndDate) {
		return true
	}
...
func (o *LineItemView) SetEndDate(v time.Time) {
	o.EndDate = &v
}

// GetGroupId returns the GroupId field value if set, zero value otherwise.
func (o *LineItemView) GetGroupId() string {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetGroupIdOk() (*string, bool) {
	if o == nil || IsNil(o.GroupId) {
		return nil, false
	}
...
func (o *LineItemView) HasGroupId() bool {
	if o != nil && !IsNil(o.GroupId) {
		return true
	}
...
func (o *LineItemView) SetGroupId(v string) {
	o.GroupId = &v
}

// GetGroupName returns the GroupName field value if set, zero value otherwise.
func (o *LineItemView) GetGroupName() string {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetGroupNameOk() (*string, bool) {
	if o == nil || IsNil(o.GroupName) {
		return nil, false
	}
...
func (o *LineItemView) HasGroupName() bool {
	if o != nil && !IsNil(o.GroupName) {
		return true
	}
...
func (o *LineItemView) SetGroupName(v string) {
	o.GroupName = &v
}

// GetNote returns the Note field value if set, zero value otherwise.
func (o *LineItemView) GetNote() string {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetNoteOk() (*string, bool) {
	if o == nil || IsNil(o.Note) {
		return nil, false
	}
	return o.Note, true
...
func (o *LineItemView) HasNote() bool {
	if o != nil && !IsNil(o.Note) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetPercentDiscountOk() (*float32, bool) {
	if o == nil || IsNil(o.PercentDiscount) {
		return nil, false
	}
...
func (o *LineItemView) HasPercentDiscount() bool {
	if o != nil && !IsNil(o.PercentDiscount) {
		return true
	}
...
func (o *LineItemView) SetPercentDiscount(v float32) {
	o.PercentDiscount = &v
}

// GetQuantity returns the Quantity field value if set, zero value otherwise.
func (o *LineItemView) GetQuantity() float64 {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetQuantityOk() (*float64, bool) {
	if o == nil || IsNil(o.Quantity) {
		return nil, false
	}
...
func (o *LineItemView) HasQuantity() bool {
	if o != nil && !IsNil(o.Quantity) {
		return true
	}
...
func (o *LineItemView) SetQuantity(v float64) {
	o.Quantity = &v
}

// GetSku returns the Sku field value if set, zero value otherwise.
func (o *LineItemView) GetSku() string {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetSkuOk() (*string, bool) {
	if o == nil || IsNil(o.Sku) {
		return nil, false
	}
	return o.Sku, true
...
func (o *LineItemView) HasSku() bool {
	if o != nil && !IsNil(o.Sku) {
		return true
	}
...
func (o *LineItemView) SetSku(v string) {
	o.Sku = &v
}

// GetStartDate returns the StartDate field value if set, zero value otherwise.
func (o *LineItemView) GetStartDate() time.Time {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetStartDateOk() (*time.Time, bool) {
	if o == nil || IsNil(o.StartDate) {
		return nil, false
	}
...
func (o *LineItemView) HasStartDate() bool {
	if o != nil && !IsNil(o.StartDate) {
		return true
	}
...
func (o *LineItemView) SetStartDate(v time.Time) {
	o.StartDate = &v
}

// GetStitchAppName returns the StitchAppName field value if set, zero value otherwise.
func (o *LineItemView) GetStitchAppName() string {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetStitchAppNameOk() (*string, bool) {
	if o == nil || IsNil(o.StitchAppName) {
		return nil, false
	}
...
func (o *LineItemView) HasStitchAppName() bool {
	if o != nil && !IsNil(o.StitchAppName) {
		return true
	}
...
func (o *LineItemView) SetStitchAppName(v string) {
	o.StitchAppName = &v
}

// GetTierLowerBound returns the TierLowerBound field value if set, zero value otherwise.
func (o *LineItemView) GetTierLowerBound() float64 {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetTierLowerBoundOk() (*float64, bool) {
	if o == nil || IsNil(o.TierLowerBound) {
		return nil, false
	}
...
func (o *LineItemView) HasTierLowerBound() bool {
	if o != nil && !IsNil(o.TierLowerBound) {
		return true
	}
...
func (o *LineItemView) SetTierLowerBound(v float64) {
	o.TierLowerBound = &v
}

// GetTierUpperBound returns the TierUpperBound field value if set, zero value otherwise.
func (o *LineItemView) GetTierUpperBound() float64 {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetTierUpperBoundOk() (*float64, bool) {
	if o == nil || IsNil(o.TierUpperBound) {
		return nil, false
	}
...
func (o *LineItemView) HasTierUpperBound() bool {
	if o != nil && !IsNil(o.TierUpperBound) {
		return true
	}
...
func (o *LineItemView) SetTierUpperBound(v float64) {
	o.TierUpperBound = &v
}

// GetTotalPriceCents returns the TotalPriceCents field value if set, zero value otherwise.
func (o *LineItemView) GetTotalPriceCents() int64 {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetTotalPriceCentsOk() (*int64, bool) {
	if o == nil || IsNil(o.TotalPriceCents) {
		return nil, false
	}
...
func (o *LineItemView) HasTotalPriceCents() bool {
	if o != nil && !IsNil(o.TotalPriceCents) {
		return true
	}
...
func (o *LineItemView) SetTotalPriceCents(v int64) {
	o.TotalPriceCents = &v
}

// GetUnit returns the Unit field value if set, zero value otherwise.
func (o *LineItemView) GetUnit() string {
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetUnitOk() (*string, bool) {
	if o == nil || IsNil(o.Unit) {
		return nil, false
	}
	return o.Unit, true
...
func (o *LineItemView) HasUnit() bool {
	if o != nil && !IsNil(o.Unit) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *LineItemView) GetUnitPriceDollarsOk() (*float64, bool) {
	if o == nil || IsNil(o.UnitPriceDollars) {
		return nil, false
	}
...
func (o *LineItemView) HasUnitPriceDollars() bool {
	if o != nil && !IsNil(o.UnitPriceDollars) {
		return true
	}
...
func (o *LineItemView) SetUnitPriceDollars(v float64) {
	o.UnitPriceDollars = &v
}

func (o LineItemView) MarshalJSON() ([]byte, error) {
...
func (o LineItemView) ToMap() (map[string]interface{}, error) {
...
type NullableLineItemView struct {
	value *LineItemView
	isSet bool
}

func (v NullableLineItemView) Get() *LineItemView {
	return v.value
}

func (v *NullableLineItemView) Set(val *LineItemView) {
	v.value = val
	v.isSet = true
}

func (v NullableLineItemView) IsSet() bool {
	return v.isSet
}

func (v *NullableLineItemView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLineItemView(val *LineItemView) *NullableLineItemView {
	return &NullableLineItemView{value: val, isSet: true}
}

func (v NullableLineItemView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLineItemView) UnmarshalJSON(src []byte) error {
	v.isSet = true
