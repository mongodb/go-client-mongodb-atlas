...
type NullableHostMetricThresholdView struct {
	value *HostMetricThresholdView
	isSet bool
}

func (v NullableHostMetricThresholdView) Get() *HostMetricThresholdView {
	return v.value
}

func (v *NullableHostMetricThresholdView) Set(val *HostMetricThresholdView) {
	v.value = val
	v.isSet = true
}

func (v NullableHostMetricThresholdView) IsSet() bool {
	return v.isSet
}

func (v *NullableHostMetricThresholdView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHostMetricThresholdView(val *HostMetricThresholdView) *NullableHostMetricThresholdView {
	return &NullableHostMetricThresholdView{value: val, isSet: true}
}

func (v NullableHostMetricThresholdView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHostMetricThresholdView) UnmarshalJSON(src []byte) error {
	v.isSet = true
