...
// checks if the EmailNotificationView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailNotificationView{}
...
func (o EmailNotificationView) ToMap() (map[string]interface{}, error) {
