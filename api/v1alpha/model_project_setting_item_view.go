...
// checks if the ProjectSettingItemView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectSettingItemView{}
...
func (o ProjectSettingItemView) ToMap() (map[string]interface{}, error) {
