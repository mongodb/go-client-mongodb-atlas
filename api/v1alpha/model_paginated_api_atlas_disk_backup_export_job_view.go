...
// checks if the PaginatedApiAtlasDiskBackupExportJobView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedApiAtlasDiskBackupExportJobView{}
...
func (o PaginatedApiAtlasDiskBackupExportJobView) ToMap() (map[string]interface{}, error) {
