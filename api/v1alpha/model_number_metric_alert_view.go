...
// checks if the NumberMetricAlertView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NumberMetricAlertView{}
...
func NewNumberMetricAlertView(acknowledgedUntil time.Time, alertConfigId string, created time.Time, eventTypeName HostMetricEventTypeViewAlertable, id string, status string, updated time.Time) *NumberMetricAlertView {
...
func (o *NumberMetricAlertView) GetEventTypeName() HostMetricEventTypeViewAlertable {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *NumberMetricAlertView) GetEventTypeNameOk() (*HostMetricEventTypeViewAlertable, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NumberMetricAlertView) SetEventTypeName(v HostMetricEventTypeViewAlertable) {
	o.EventTypeName = v
}
...
func (o *NumberMetricAlertView) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
func (o NumberMetricAlertView) ToMap() (map[string]interface{}, error) {
