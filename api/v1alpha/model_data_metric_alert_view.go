...
// checks if the DataMetricAlertView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DataMetricAlertView{}
...
func NewDataMetricAlertView(acknowledgedUntil time.Time, alertConfigId string, created time.Time, eventTypeName HostMetricEventTypeViewAlertable, id string, status string, updated time.Time) *DataMetricAlertView {
...
func (o *DataMetricAlertView) GetEventTypeName() HostMetricEventTypeViewAlertable {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *DataMetricAlertView) GetEventTypeNameOk() (*HostMetricEventTypeViewAlertable, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DataMetricAlertView) SetEventTypeName(v HostMetricEventTypeViewAlertable) {
	o.EventTypeName = v
}
...
func (o *DataMetricAlertView) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
func (o DataMetricAlertView) ToMap() (map[string]interface{}, error) {
