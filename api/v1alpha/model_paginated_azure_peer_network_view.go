...
// checks if the PaginatedAzurePeerNetworkView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedAzurePeerNetworkView{}
...
func NewPaginatedAzurePeerNetworkView() *PaginatedAzurePeerNetworkView {
...
func (o *PaginatedAzurePeerNetworkView) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
func (o *PaginatedAzurePeerNetworkView) GetResults() []AzurePeerNetwork {
...
// and a boolean to check if the value has been set.
func (o *PaginatedAzurePeerNetworkView) GetResultsOk() ([]AzurePeerNetwork, bool) {
	if o == nil || IsNil(o.Results) {
		return nil, false
	}
...
func (o *PaginatedAzurePeerNetworkView) HasResults() bool {
	if o != nil && !IsNil(o.Results) {
		return true
	}
...
func (o *PaginatedAzurePeerNetworkView) SetResults(v []AzurePeerNetwork) {
	o.Results = v
}
...
func (o *PaginatedAzurePeerNetworkView) HasTotalCount() bool {
	if o != nil && !IsNil(o.TotalCount) {
		return true
	}
...
func (o PaginatedAzurePeerNetworkView) ToMap() (map[string]interface{}, error) {
