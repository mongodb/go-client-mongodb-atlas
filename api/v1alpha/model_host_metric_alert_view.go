...
// DataMetricAlertViewAsHostMetricAlertView is a convenience function that returns DataMetricAlertView wrapped in HostMetricAlertView
func DataMetricAlertViewAsHostMetricAlertView(v *DataMetricAlertView) HostMetricAlertView {
	return HostMetricAlertView{
		DataMetricAlertView: v,
	}
}

// NumberMetricAlertViewAsHostMetricAlertView is a convenience function that returns NumberMetricAlertView wrapped in HostMetricAlertView
func NumberMetricAlertViewAsHostMetricAlertView(v *NumberMetricAlertView) HostMetricAlertView {
	return HostMetricAlertView{
		NumberMetricAlertView: v,
	}
}

// RawMetricAlertViewAsHostMetricAlertView is a convenience function that returns RawMetricAlertView wrapped in HostMetricAlertView
func RawMetricAlertViewAsHostMetricAlertView(v *RawMetricAlertView) HostMetricAlertView {
	return HostMetricAlertView{
		RawMetricAlertView: v,
	}
}

// TimeMetricAlertViewAsHostMetricAlertView is a convenience function that returns TimeMetricAlertView wrapped in HostMetricAlertView
func TimeMetricAlertViewAsHostMetricAlertView(v *TimeMetricAlertView) HostMetricAlertView {
	return HostMetricAlertView{
		TimeMetricAlertView: v,
	}
}


// Unmarshal JSON data into one of the pointers in the struct
func (dst *HostMetricAlertView) UnmarshalJSON(data []byte) error {
	var err error
	...
	if jsonDict["metricName"] == "ASSERT_MSG" {
		// try to unmarshal JSON data into RawMetricAlertView
		err = json.Unmarshal(data, &dst.RawMetricAlertView)
		if err == nil {
			return nil // data stored in dst.RawMetricAlertView, return on the first match
		} else {
			dst.RawMetricAlertView = nil
			return fmt.Errorf("failed to unmarshal HostMetricAlertView as RawMetricAlertView: %s", err.Error())
		}
	}
	...
	if jsonDict["metricName"] == "AVG_COMMAND_EXECUTION_TIME" {
		// try to unmarshal JSON data into TimeMetricAlertView
		err = json.Unmarshal(data, &dst.TimeMetricAlertView)
		if err == nil {
			return nil // data stored in dst.TimeMetricAlertView, return on the first match
		} else {
			dst.TimeMetricAlertView = nil
			return fmt.Errorf("failed to unmarshal HostMetricAlertView as TimeMetricAlertView: %s", err.Error())
		}
	}
	...
	if jsonDict["metricName"] == "CACHE_BYTES_READ_INTO" {
		// try to unmarshal JSON data into DataMetricAlertView
		err = json.Unmarshal(data, &dst.DataMetricAlertView)
		if err == nil {
			return nil // data stored in dst.DataMetricAlertView, return on the first match
		} else {
			dst.DataMetricAlertView = nil
			return fmt.Errorf("failed to unmarshal HostMetricAlertView as DataMetricAlertView: %s", err.Error())
		}
	}
	...
	// check if the discriminator value is 'DataMetricAlertView'
	if jsonDict["metricName"] == "DataMetricAlertView" {
		// try to unmarshal JSON data into DataMetricAlertView
		err = json.Unmarshal(data, &dst.DataMetricAlertView)
		if err == nil {
			return nil // data stored in dst.DataMetricAlertView, return on the first match
	...
	// check if the discriminator value is 'NumberMetricAlertView'
	if jsonDict["metricName"] == "NumberMetricAlertView" {
		// try to unmarshal JSON data into NumberMetricAlertView
		err = json.Unmarshal(data, &dst.NumberMetricAlertView)
		if err == nil {
			return nil // data stored in dst.NumberMetricAlertView, return on the first match
		} else {
			dst.NumberMetricAlertView = nil
			return fmt.Errorf("failed to unmarshal HostMetricAlertView as NumberMetricAlertView: %s", err.Error())
		}
	}
	...
	// check if the discriminator value is 'RawMetricAlertView'
	if jsonDict["metricName"] == "RawMetricAlertView" {
		// try to unmarshal JSON data into RawMetricAlertView
		err = json.Unmarshal(data, &dst.RawMetricAlertView)
		if err == nil {
			return nil // data stored in dst.RawMetricAlertView, return on the first match
	...
	// check if the discriminator value is 'TimeMetricAlertView'
	if jsonDict["metricName"] == "TimeMetricAlertView" {
		// try to unmarshal JSON data into TimeMetricAlertView
		err = json.Unmarshal(data, &dst.TimeMetricAlertView)
		if err == nil {
			return nil // data stored in dst.TimeMetricAlertView, return on the first match
...
func (src HostMetricAlertView) MarshalJSON() ([]byte, error) {
	if src.DataMetricAlertView != nil {
		return json.Marshal(&src.DataMetricAlertView)
	}

	if src.NumberMetricAlertView != nil {
		return json.Marshal(&src.NumberMetricAlertView)
	}

	if src.RawMetricAlertView != nil {
		return json.Marshal(&src.RawMetricAlertView)
	}

	if src.TimeMetricAlertView != nil {
		return json.Marshal(&src.TimeMetricAlertView)
	}
...
func (obj *HostMetricAlertView) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
	if obj.DataMetricAlertView != nil {
		return obj.DataMetricAlertView
	}

	if obj.NumberMetricAlertView != nil {
		return obj.NumberMetricAlertView
	}

	if obj.RawMetricAlertView != nil {
		return obj.RawMetricAlertView
	}

	if obj.TimeMetricAlertView != nil {
		return obj.TimeMetricAlertView
	}
