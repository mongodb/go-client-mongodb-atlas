...
func (o *HostMetricAlertView) GetEventTypeName() HostMetricEventTypeViewAlertable {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *HostMetricAlertView) GetEventTypeNameOk() (*HostMetricEventTypeViewAlertable, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HostMetricAlertView) SetEventTypeName(v HostMetricEventTypeViewAlertable) {
	o.EventTypeName = v
}
...
func (o *HostMetricAlertView) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
