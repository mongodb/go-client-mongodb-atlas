...
func (o *HostMetricAlertView) GetEventTypeName() HostMetricEventType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *HostMetricAlertView) GetEventTypeNameOk() (*HostMetricEventType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *HostMetricAlertView) SetEventTypeName(v HostMetricEventType) {
	o.EventTypeName = v
}
