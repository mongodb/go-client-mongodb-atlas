...
// checks if the PaginatedOnlineArchiveView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedOnlineArchiveView{}
...
func (o PaginatedOnlineArchiveView) ToMap() (map[string]interface{}, error) {
