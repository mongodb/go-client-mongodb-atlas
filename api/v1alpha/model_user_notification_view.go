...
// checks if the UserNotificationView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserNotificationView{}

// UserNotificationView User notification configuration for MongoDB Cloud to send information when an event triggers an alert condition.
...
// NewUserNotificationView instantiates a new UserNotificationView object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUserNotificationView(typeName string) *UserNotificationView {
	this := UserNotificationView{}
	this.TypeName = typeName
	return &this
}

// NewUserNotificationViewWithDefaults instantiates a new UserNotificationView object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUserNotificationViewWithDefaults() *UserNotificationView {
	this := UserNotificationView{}
	return &this
}

// GetDelayMin returns the DelayMin field value if set, zero value otherwise.
func (o *UserNotificationView) GetDelayMin() int32 {
...
func (o *UserNotificationView) GetDelayMinOk() (*int32, bool) {
	if o == nil || IsNil(o.DelayMin) {
		return nil, false
	}
...
func (o *UserNotificationView) HasDelayMin() bool {
	if o != nil && !IsNil(o.DelayMin) {
		return true
	}
...
func (o *UserNotificationView) SetDelayMin(v int32) {
	o.DelayMin = &v
}

// GetEmailEnabled returns the EmailEnabled field value if set, zero value otherwise.
func (o *UserNotificationView) GetEmailEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *UserNotificationView) GetEmailEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.EmailEnabled) {
		return nil, false
	}
...
func (o *UserNotificationView) HasEmailEnabled() bool {
	if o != nil && !IsNil(o.EmailEnabled) {
		return true
	}
...
func (o *UserNotificationView) SetEmailEnabled(v bool) {
	o.EmailEnabled = &v
}

// GetIntervalMin returns the IntervalMin field value if set, zero value otherwise.
func (o *UserNotificationView) GetIntervalMin() int32 {
...
// and a boolean to check if the value has been set.
func (o *UserNotificationView) GetIntervalMinOk() (*int32, bool) {
	if o == nil || IsNil(o.IntervalMin) {
		return nil, false
	}
...
func (o *UserNotificationView) HasIntervalMin() bool {
	if o != nil && !IsNil(o.IntervalMin) {
		return true
	}
...
func (o *UserNotificationView) SetIntervalMin(v int32) {
	o.IntervalMin = &v
}

// GetSmsEnabled returns the SmsEnabled field value if set, zero value otherwise.
func (o *UserNotificationView) GetSmsEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *UserNotificationView) GetSmsEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.SmsEnabled) {
		return nil, false
	}
...
func (o *UserNotificationView) HasSmsEnabled() bool {
	if o != nil && !IsNil(o.SmsEnabled) {
		return true
	}
...
func (o *UserNotificationView) SetSmsEnabled(v bool) {
	o.SmsEnabled = &v
}

// GetTypeName returns the TypeName field value
func (o *UserNotificationView) GetTypeName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UserNotificationView) GetTypeNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *UserNotificationView) SetTypeName(v string) {
	o.TypeName = v
}

// GetUsername returns the Username field value if set, zero value otherwise.
func (o *UserNotificationView) GetUsername() string {
...
// and a boolean to check if the value has been set.
func (o *UserNotificationView) GetUsernameOk() (*string, bool) {
	if o == nil || IsNil(o.Username) {
		return nil, false
	}
...
func (o *UserNotificationView) HasUsername() bool {
	if o != nil && !IsNil(o.Username) {
		return true
	}
...
func (o *UserNotificationView) SetUsername(v string) {
	o.Username = &v
}

func (o UserNotificationView) MarshalJSON() ([]byte, error) {
...
func (o UserNotificationView) ToMap() (map[string]interface{}, error) {
...
type NullableUserNotificationView struct {
	value *UserNotificationView
	isSet bool
}

func (v NullableUserNotificationView) Get() *UserNotificationView {
	return v.value
}

func (v *NullableUserNotificationView) Set(val *UserNotificationView) {
	v.value = val
	v.isSet = true
}

func (v NullableUserNotificationView) IsSet() bool {
	return v.isSet
}

func (v *NullableUserNotificationView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserNotificationView(val *UserNotificationView) *NullableUserNotificationView {
	return &NullableUserNotificationView{value: val, isSet: true}
}

func (v NullableUserNotificationView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserNotificationView) UnmarshalJSON(src []byte) error {
	v.isSet = true
