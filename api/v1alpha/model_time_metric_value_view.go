...
// checks if the TimeMetricValueView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeMetricValueView{}
...
func (o TimeMetricValueView) ToMap() (map[string]interface{}, error) {
