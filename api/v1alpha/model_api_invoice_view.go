...
// checks if the ApiInvoiceView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiInvoiceView{}
...
func (o ApiInvoiceView) ToMap() (map[string]interface{}, error) {
