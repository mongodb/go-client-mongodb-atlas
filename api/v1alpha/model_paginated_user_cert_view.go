...
// checks if the PaginatedUserCertView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedUserCertView{}
...
func (o PaginatedUserCertView) ToMap() (map[string]interface{}, error) {
