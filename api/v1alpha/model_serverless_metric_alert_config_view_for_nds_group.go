...
// checks if the ServerlessMetricAlertConfigViewForNdsGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServerlessMetricAlertConfigViewForNdsGroup{}

// ServerlessMetricAlertConfigViewForNdsGroup Serverless metric alert configuration allows to select which serverless database metrics trigger alerts and how users are notified.
type ServerlessMetricAlertConfigViewForNdsGroup struct {
	...
	EventTypeName ServerlessEventTypeViewAlertable `json:"eventTypeName"`
...
func NewServerlessMetricAlertConfigViewForNdsGroup() *ServerlessMetricAlertConfigViewForNdsGroup {
	this := ServerlessMetricAlertConfigViewForNdsGroup{}
	var enabled bool = false
	this.Enabled = &enabled
	return &this
}

// NewServerlessMetricAlertConfigViewForNdsGroupWithDefaults instantiates a new ServerlessMetricAlertConfigViewForNdsGroup object
...
func (o *ServerlessMetricAlertConfigViewForNdsGroup) SetNotifications(v []NotificationViewForNdsGroup) {
	o.Notifications = v
}
...
type NullableServerlessMetricAlertConfigViewForNdsGroup struct {
	value *ServerlessMetricAlertConfigViewForNdsGroup
	isSet bool
}

func (v NullableServerlessMetricAlertConfigViewForNdsGroup) Get() *ServerlessMetricAlertConfigViewForNdsGroup {
	return v.value
}

func (v *NullableServerlessMetricAlertConfigViewForNdsGroup) Set(val *ServerlessMetricAlertConfigViewForNdsGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableServerlessMetricAlertConfigViewForNdsGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableServerlessMetricAlertConfigViewForNdsGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerlessMetricAlertConfigViewForNdsGroup(val *ServerlessMetricAlertConfigViewForNdsGroup) *NullableServerlessMetricAlertConfigViewForNdsGroup {
	return &NullableServerlessMetricAlertConfigViewForNdsGroup{value: val, isSet: true}
}

func (v NullableServerlessMetricAlertConfigViewForNdsGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerlessMetricAlertConfigViewForNdsGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
