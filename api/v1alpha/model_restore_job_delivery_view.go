...
// checks if the RestoreJobDeliveryView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RestoreJobDeliveryView{}

// RestoreJobDeliveryView Method and details that indicate how to deliver the restored snapshot data.
type RestoreJobDeliveryView struct {
...
// NewRestoreJobDeliveryView instantiates a new RestoreJobDeliveryView object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRestoreJobDeliveryView(methodName string) *RestoreJobDeliveryView {
	this := RestoreJobDeliveryView{}
	this.MethodName = methodName
	return &this
}

// NewRestoreJobDeliveryViewWithDefaults instantiates a new RestoreJobDeliveryView object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewRestoreJobDeliveryViewWithDefaults() *RestoreJobDeliveryView {
	this := RestoreJobDeliveryView{}
	return &this
}

// GetAuthHeader returns the AuthHeader field value if set, zero value otherwise.
func (o *RestoreJobDeliveryView) GetAuthHeader() string {
...
func (o *RestoreJobDeliveryView) GetAuthHeaderOk() (*string, bool) {
	if o == nil || IsNil(o.AuthHeader) {
		return nil, false
	}
...
func (o *RestoreJobDeliveryView) HasAuthHeader() bool {
	if o != nil && !IsNil(o.AuthHeader) {
		return true
	}
...
func (o *RestoreJobDeliveryView) SetAuthHeader(v string) {
	o.AuthHeader = &v
}

// GetAuthValue returns the AuthValue field value if set, zero value otherwise.
func (o *RestoreJobDeliveryView) GetAuthValue() string {
...
// and a boolean to check if the value has been set.
func (o *RestoreJobDeliveryView) GetAuthValueOk() (*string, bool) {
	if o == nil || IsNil(o.AuthValue) {
		return nil, false
	}
...
func (o *RestoreJobDeliveryView) HasAuthValue() bool {
	if o != nil && !IsNil(o.AuthValue) {
		return true
	}
...
func (o *RestoreJobDeliveryView) SetAuthValue(v string) {
	o.AuthValue = &v
}

// GetExpirationHours returns the ExpirationHours field value if set, zero value otherwise.
func (o *RestoreJobDeliveryView) GetExpirationHours() int32 {
...
// and a boolean to check if the value has been set.
func (o *RestoreJobDeliveryView) GetExpirationHoursOk() (*int32, bool) {
	if o == nil || IsNil(o.ExpirationHours) {
		return nil, false
	}
...
func (o *RestoreJobDeliveryView) HasExpirationHours() bool {
	if o != nil && !IsNil(o.ExpirationHours) {
		return true
	}
...
func (o *RestoreJobDeliveryView) SetExpirationHours(v int32) {
	o.ExpirationHours = &v
}

// GetExpires returns the Expires field value if set, zero value otherwise.
func (o *RestoreJobDeliveryView) GetExpires() time.Time {
...
// and a boolean to check if the value has been set.
func (o *RestoreJobDeliveryView) GetExpiresOk() (*time.Time, bool) {
	if o == nil || IsNil(o.Expires) {
		return nil, false
	}
...
func (o *RestoreJobDeliveryView) HasExpires() bool {
	if o != nil && !IsNil(o.Expires) {
		return true
	}
...
func (o *RestoreJobDeliveryView) SetExpires(v time.Time) {
	o.Expires = &v
}

// GetMaxDownloads returns the MaxDownloads field value if set, zero value otherwise.
func (o *RestoreJobDeliveryView) GetMaxDownloads() int32 {
...
// and a boolean to check if the value has been set.
func (o *RestoreJobDeliveryView) GetMaxDownloadsOk() (*int32, bool) {
	if o == nil || IsNil(o.MaxDownloads) {
		return nil, false
	}
...
func (o *RestoreJobDeliveryView) HasMaxDownloads() bool {
	if o != nil && !IsNil(o.MaxDownloads) {
		return true
	}
...
func (o *RestoreJobDeliveryView) SetMaxDownloads(v int32) {
	o.MaxDownloads = &v
}

// GetMethodName returns the MethodName field value
func (o *RestoreJobDeliveryView) GetMethodName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *RestoreJobDeliveryView) GetMethodNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RestoreJobDeliveryView) SetMethodName(v string) {
	o.MethodName = v
}

// GetStatusName returns the StatusName field value if set, zero value otherwise.
func (o *RestoreJobDeliveryView) GetStatusName() string {
...
// and a boolean to check if the value has been set.
func (o *RestoreJobDeliveryView) GetStatusNameOk() (*string, bool) {
	if o == nil || IsNil(o.StatusName) {
		return nil, false
	}
...
func (o *RestoreJobDeliveryView) HasStatusName() bool {
	if o != nil && !IsNil(o.StatusName) {
		return true
	}
...
func (o *RestoreJobDeliveryView) SetStatusName(v string) {
	o.StatusName = &v
}

// GetTargetClusterId returns the TargetClusterId field value if set, zero value otherwise.
func (o *RestoreJobDeliveryView) GetTargetClusterId() string {
...
// and a boolean to check if the value has been set.
func (o *RestoreJobDeliveryView) GetTargetClusterIdOk() (*string, bool) {
	if o == nil || IsNil(o.TargetClusterId) {
		return nil, false
	}
...
func (o *RestoreJobDeliveryView) HasTargetClusterId() bool {
	if o != nil && !IsNil(o.TargetClusterId) {
		return true
	}
...
func (o *RestoreJobDeliveryView) SetTargetClusterId(v string) {
	o.TargetClusterId = &v
}

// GetTargetClusterName returns the TargetClusterName field value if set, zero value otherwise.
func (o *RestoreJobDeliveryView) GetTargetClusterName() string {
...
// and a boolean to check if the value has been set.
func (o *RestoreJobDeliveryView) GetTargetClusterNameOk() (*string, bool) {
	if o == nil || IsNil(o.TargetClusterName) {
		return nil, false
	}
...
func (o *RestoreJobDeliveryView) HasTargetClusterName() bool {
	if o != nil && !IsNil(o.TargetClusterName) {
		return true
	}
...
func (o *RestoreJobDeliveryView) SetTargetClusterName(v string) {
	o.TargetClusterName = &v
}

// GetTargetGroupId returns the TargetGroupId field value if set, zero value otherwise.
func (o *RestoreJobDeliveryView) GetTargetGroupId() string {
...
// and a boolean to check if the value has been set.
func (o *RestoreJobDeliveryView) GetTargetGroupIdOk() (*string, bool) {
	if o == nil || IsNil(o.TargetGroupId) {
		return nil, false
	}
...
func (o *RestoreJobDeliveryView) HasTargetGroupId() bool {
	if o != nil && !IsNil(o.TargetGroupId) {
		return true
	}
...
func (o *RestoreJobDeliveryView) SetTargetGroupId(v string) {
	o.TargetGroupId = &v
}

// GetUrl returns the Url field value if set, zero value otherwise.
// Deprecated
func (o *RestoreJobDeliveryView) GetUrl() string {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *RestoreJobDeliveryView) GetUrlOk() (*string, bool) {
	if o == nil || IsNil(o.Url) {
		return nil, false
	}
	return o.Url, true
...
func (o *RestoreJobDeliveryView) HasUrl() bool {
	if o != nil && !IsNil(o.Url) {
		return true
	}
...
// Deprecated
func (o *RestoreJobDeliveryView) SetUrl(v string) {
	o.Url = &v
}

// GetUrlV2 returns the UrlV2 field value if set, zero value otherwise.
func (o *RestoreJobDeliveryView) GetUrlV2() string {
...
// and a boolean to check if the value has been set.
func (o *RestoreJobDeliveryView) GetUrlV2Ok() (*string, bool) {
	if o == nil || IsNil(o.UrlV2) {
		return nil, false
	}
	return o.UrlV2, true
...
func (o *RestoreJobDeliveryView) HasUrlV2() bool {
	if o != nil && !IsNil(o.UrlV2) {
		return true
	}
...
func (o *RestoreJobDeliveryView) SetUrlV2(v string) {
	o.UrlV2 = &v
}

func (o RestoreJobDeliveryView) MarshalJSON() ([]byte, error) {
...
func (o RestoreJobDeliveryView) ToMap() (map[string]interface{}, error) {
...
type NullableRestoreJobDeliveryView struct {
	value *RestoreJobDeliveryView
	isSet bool
}

func (v NullableRestoreJobDeliveryView) Get() *RestoreJobDeliveryView {
	return v.value
}

func (v *NullableRestoreJobDeliveryView) Set(val *RestoreJobDeliveryView) {
	v.value = val
	v.isSet = true
}

func (v NullableRestoreJobDeliveryView) IsSet() bool {
	return v.isSet
}

func (v *NullableRestoreJobDeliveryView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRestoreJobDeliveryView(val *RestoreJobDeliveryView) *NullableRestoreJobDeliveryView {
	return &NullableRestoreJobDeliveryView{value: val, isSet: true}
}

func (v NullableRestoreJobDeliveryView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRestoreJobDeliveryView) UnmarshalJSON(src []byte) error {
	v.isSet = true
