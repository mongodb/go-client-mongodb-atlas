...
func NewTimeMetricEventView(created time.Time, eventTypeName HostMetricEventTypeView, id string) *TimeMetricEventView {
...
func (o *TimeMetricEventView) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
