...
// checks if the TimeMetricAlertView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimeMetricAlertView{}

// TimeMetricAlertView struct for TimeMetricAlertView
type TimeMetricAlertView struct {
...
// NewTimeMetricAlertView instantiates a new TimeMetricAlertView object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTimeMetricAlertView(acknowledgedUntil time.Time, alertConfigId string, created time.Time, eventTypeName HostMetricEventTypeViewAlertable, id string, status string, updated time.Time) *TimeMetricAlertView {
	this := TimeMetricAlertView{}
...
// NewTimeMetricAlertViewWithDefaults instantiates a new TimeMetricAlertView object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTimeMetricAlertViewWithDefaults() *TimeMetricAlertView {
	this := TimeMetricAlertView{}
	return &this
}

// GetAcknowledgedUntil returns the AcknowledgedUntil field value
func (o *TimeMetricAlertView) GetAcknowledgedUntil() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
func (o *TimeMetricAlertView) GetAcknowledgedUntilOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TimeMetricAlertView) SetAcknowledgedUntil(v time.Time) {
...
func (o *TimeMetricAlertView) GetAcknowledgementComment() string {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetAcknowledgementCommentOk() (*string, bool) {
	if o == nil || IsNil(o.AcknowledgementComment) {
		return nil, false
	}
...
func (o *TimeMetricAlertView) HasAcknowledgementComment() bool {
	if o != nil && !IsNil(o.AcknowledgementComment) {
		return true
	}
...
func (o *TimeMetricAlertView) SetAcknowledgementComment(v string) {
...
func (o *TimeMetricAlertView) GetAcknowledgingUsername() string {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetAcknowledgingUsernameOk() (*string, bool) {
	if o == nil || IsNil(o.AcknowledgingUsername) {
		return nil, false
	}
...
func (o *TimeMetricAlertView) HasAcknowledgingUsername() bool {
	if o != nil && !IsNil(o.AcknowledgingUsername) {
		return true
	}
...
func (o *TimeMetricAlertView) SetAcknowledgingUsername(v string) {
	o.AcknowledgingUsername = &v
}

// GetAlertConfigId returns the AlertConfigId field value
func (o *TimeMetricAlertView) GetAlertConfigId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetAlertConfigIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TimeMetricAlertView) SetAlertConfigId(v string) {
	o.AlertConfigId = v
}

// GetClusterName returns the ClusterName field value if set, zero value otherwise.
func (o *TimeMetricAlertView) GetClusterName() string {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetClusterNameOk() (*string, bool) {
	if o == nil || IsNil(o.ClusterName) {
		return nil, false
	}
...
func (o *TimeMetricAlertView) HasClusterName() bool {
	if o != nil && !IsNil(o.ClusterName) {
		return true
	}
...
func (o *TimeMetricAlertView) SetClusterName(v string) {
	o.ClusterName = &v
}

// GetCreated returns the Created field value
func (o *TimeMetricAlertView) GetCreated() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetCreatedOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TimeMetricAlertView) SetCreated(v time.Time) {
	o.Created = v
}

// GetCurrentValue returns the CurrentValue field value if set, zero value otherwise.
func (o *TimeMetricAlertView) GetCurrentValue() TimeMetricValueView {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetCurrentValueOk() (*TimeMetricValueView, bool) {
	if o == nil || IsNil(o.CurrentValue) {
		return nil, false
	}
...
func (o *TimeMetricAlertView) HasCurrentValue() bool {
	if o != nil && !IsNil(o.CurrentValue) {
		return true
	}
...
func (o *TimeMetricAlertView) SetCurrentValue(v TimeMetricValueView) {
	o.CurrentValue = &v
}
...
func (o *TimeMetricAlertView) GetGroupId() string {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetGroupIdOk() (*string, bool) {
	if o == nil || IsNil(o.GroupId) {
		return nil, false
	}
...
func (o *TimeMetricAlertView) HasGroupId() bool {
	if o != nil && !IsNil(o.GroupId) {
		return true
	}
...
func (o *TimeMetricAlertView) SetGroupId(v string) {
	o.GroupId = &v
}

// GetHostnameAndPort returns the HostnameAndPort field value if set, zero value otherwise.
func (o *TimeMetricAlertView) GetHostnameAndPort() string {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetHostnameAndPortOk() (*string, bool) {
	if o == nil || IsNil(o.HostnameAndPort) {
		return nil, false
	}
...
func (o *TimeMetricAlertView) HasHostnameAndPort() bool {
	if o != nil && !IsNil(o.HostnameAndPort) {
		return true
	}
...
func (o *TimeMetricAlertView) SetHostnameAndPort(v string) {
	o.HostnameAndPort = &v
}

// GetId returns the Id field value
func (o *TimeMetricAlertView) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *TimeMetricAlertView) SetId(v string) {
	o.Id = v
}

// GetLastNotified returns the LastNotified field value if set, zero value otherwise.
func (o *TimeMetricAlertView) GetLastNotified() time.Time {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetLastNotifiedOk() (*time.Time, bool) {
	if o == nil || IsNil(o.LastNotified) {
		return nil, false
	}
...
func (o *TimeMetricAlertView) HasLastNotified() bool {
	if o != nil && !IsNil(o.LastNotified) {
		return true
	}
...
func (o *TimeMetricAlertView) SetLastNotified(v time.Time) {
	o.LastNotified = &v
}

// GetLinks returns the Links field value if set, zero value otherwise.
func (o *TimeMetricAlertView) GetLinks() []Link {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetLinksOk() ([]Link, bool) {
	if o == nil || IsNil(o.Links) {
		return nil, false
	}
	return o.Links, true
...
func (o *TimeMetricAlertView) HasLinks() bool {
	if o != nil && !IsNil(o.Links) {
		return true
	}
...
func (o *TimeMetricAlertView) SetLinks(v []Link) {
	o.Links = v
}

// GetMetricName returns the MetricName field value if set, zero value otherwise.
func (o *TimeMetricAlertView) GetMetricName() string {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetMetricNameOk() (*string, bool) {
	if o == nil || IsNil(o.MetricName) {
		return nil, false
	}
...
func (o *TimeMetricAlertView) HasMetricName() bool {
	if o != nil && !IsNil(o.MetricName) {
		return true
	}
...
func (o *TimeMetricAlertView) SetMetricName(v string) {
	o.MetricName = &v
}

// GetOrgId returns the OrgId field value if set, zero value otherwise.
func (o *TimeMetricAlertView) GetOrgId() string {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetOrgIdOk() (*string, bool) {
	if o == nil || IsNil(o.OrgId) {
		return nil, false
	}
	return o.OrgId, true
...
func (o *TimeMetricAlertView) HasOrgId() bool {
	if o != nil && !IsNil(o.OrgId) {
		return true
	}
...
func (o *TimeMetricAlertView) SetOrgId(v string) {
	o.OrgId = &v
}

// GetReplicaSetName returns the ReplicaSetName field value if set, zero value otherwise.
func (o *TimeMetricAlertView) GetReplicaSetName() string {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetReplicaSetNameOk() (*string, bool) {
	if o == nil || IsNil(o.ReplicaSetName) {
		return nil, false
	}
...
func (o *TimeMetricAlertView) HasReplicaSetName() bool {
	if o != nil && !IsNil(o.ReplicaSetName) {
		return true
	}
...
func (o *TimeMetricAlertView) SetReplicaSetName(v string) {
	o.ReplicaSetName = &v
}

// GetResolved returns the Resolved field value if set, zero value otherwise.
func (o *TimeMetricAlertView) GetResolved() time.Time {
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetResolvedOk() (*time.Time, bool) {
	if o == nil || IsNil(o.Resolved) {
		return nil, false
	}
...
func (o *TimeMetricAlertView) HasResolved() bool {
	if o != nil && !IsNil(o.Resolved) {
		return true
	}
...
func (o *TimeMetricAlertView) SetResolved(v time.Time) {
	o.Resolved = &v
}

// GetStatus returns the Status field value
func (o *TimeMetricAlertView) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TimeMetricAlertView) SetStatus(v string) {
	o.Status = v
}

// GetUpdated returns the Updated field value
func (o *TimeMetricAlertView) GetUpdated() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TimeMetricAlertView) GetUpdatedOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TimeMetricAlertView) SetUpdated(v time.Time) {
	o.Updated = v
}

func (o TimeMetricAlertView) MarshalJSON() ([]byte, error) {
...
func (o TimeMetricAlertView) ToMap() (map[string]interface{}, error) {
...
type NullableTimeMetricAlertView struct {
	value *TimeMetricAlertView
	isSet bool
}

func (v NullableTimeMetricAlertView) Get() *TimeMetricAlertView {
	return v.value
}

func (v *NullableTimeMetricAlertView) Set(val *TimeMetricAlertView) {
	v.value = val
	v.isSet = true
}

func (v NullableTimeMetricAlertView) IsSet() bool {
	return v.isSet
}

func (v *NullableTimeMetricAlertView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimeMetricAlertView(val *TimeMetricAlertView) *NullableTimeMetricAlertView {
	return &NullableTimeMetricAlertView{value: val, isSet: true}
}

func (v NullableTimeMetricAlertView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimeMetricAlertView) UnmarshalJSON(src []byte) error {
	v.isSet = true
