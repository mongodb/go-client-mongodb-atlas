...
// checks if the GroupNotificationView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupNotificationView{}

// GroupNotificationView Group notification configuration for MongoDB Cloud to send information when an event triggers an alert condition.
type GroupNotificationView struct {
...
// NewGroupNotificationView instantiates a new GroupNotificationView object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGroupNotificationView(typeName string) *GroupNotificationView {
	this := GroupNotificationView{}
	this.TypeName = typeName
	return &this
}

// NewGroupNotificationViewWithDefaults instantiates a new GroupNotificationView object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGroupNotificationViewWithDefaults() *GroupNotificationView {
	this := GroupNotificationView{}
	return &this
}

// GetDelayMin returns the DelayMin field value if set, zero value otherwise.
func (o *GroupNotificationView) GetDelayMin() int32 {
...
func (o *GroupNotificationView) GetDelayMinOk() (*int32, bool) {
	if o == nil || IsNil(o.DelayMin) {
		return nil, false
	}
...
func (o *GroupNotificationView) HasDelayMin() bool {
	if o != nil && !IsNil(o.DelayMin) {
		return true
	}
...
func (o *GroupNotificationView) SetDelayMin(v int32) {
	o.DelayMin = &v
}

// GetEmailEnabled returns the EmailEnabled field value if set, zero value otherwise.
func (o *GroupNotificationView) GetEmailEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *GroupNotificationView) GetEmailEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.EmailEnabled) {
		return nil, false
	}
...
func (o *GroupNotificationView) HasEmailEnabled() bool {
	if o != nil && !IsNil(o.EmailEnabled) {
		return true
	}
...
func (o *GroupNotificationView) SetEmailEnabled(v bool) {
	o.EmailEnabled = &v
}

// GetIntervalMin returns the IntervalMin field value if set, zero value otherwise.
func (o *GroupNotificationView) GetIntervalMin() int32 {
...
// and a boolean to check if the value has been set.
func (o *GroupNotificationView) GetIntervalMinOk() (*int32, bool) {
	if o == nil || IsNil(o.IntervalMin) {
		return nil, false
	}
...
func (o *GroupNotificationView) HasIntervalMin() bool {
	if o != nil && !IsNil(o.IntervalMin) {
		return true
	}
...
func (o *GroupNotificationView) SetIntervalMin(v int32) {
	o.IntervalMin = &v
}

// GetRoles returns the Roles field value if set, zero value otherwise.
func (o *GroupNotificationView) GetRoles() []string {
...
// and a boolean to check if the value has been set.
func (o *GroupNotificationView) GetRolesOk() ([]string, bool) {
	if o == nil || IsNil(o.Roles) {
		return nil, false
	}
	return o.Roles, true
...
func (o *GroupNotificationView) HasRoles() bool {
	if o != nil && !IsNil(o.Roles) {
		return true
	}
...
func (o *GroupNotificationView) SetRoles(v []string) {
	o.Roles = v
}

// GetSmsEnabled returns the SmsEnabled field value if set, zero value otherwise.
func (o *GroupNotificationView) GetSmsEnabled() bool {
...
// and a boolean to check if the value has been set.
func (o *GroupNotificationView) GetSmsEnabledOk() (*bool, bool) {
	if o == nil || IsNil(o.SmsEnabled) {
		return nil, false
	}
...
func (o *GroupNotificationView) HasSmsEnabled() bool {
	if o != nil && !IsNil(o.SmsEnabled) {
		return true
	}
...
func (o *GroupNotificationView) SetSmsEnabled(v bool) {
	o.SmsEnabled = &v
}

// GetTypeName returns the TypeName field value
func (o *GroupNotificationView) GetTypeName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GroupNotificationView) GetTypeNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GroupNotificationView) SetTypeName(v string) {
	o.TypeName = v
}

func (o GroupNotificationView) MarshalJSON() ([]byte, error) {
...
func (o GroupNotificationView) ToMap() (map[string]interface{}, error) {
...
type NullableGroupNotificationView struct {
	value *GroupNotificationView
	isSet bool
}

func (v NullableGroupNotificationView) Get() *GroupNotificationView {
	return v.value
}

func (v *NullableGroupNotificationView) Set(val *GroupNotificationView) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupNotificationView) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupNotificationView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupNotificationView(val *GroupNotificationView) *NullableGroupNotificationView {
	return &NullableGroupNotificationView{value: val, isSet: true}
}

func (v NullableGroupNotificationView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupNotificationView) UnmarshalJSON(src []byte) error {
	v.isSet = true
