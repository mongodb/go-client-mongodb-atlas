...
// checks if the PaginatedApiAppUserView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedApiAppUserView{}
...
func (o *PaginatedApiAppUserView) GetResults() []AppUserView {
...
// and a boolean to check if the value has been set.
func (o *PaginatedApiAppUserView) GetResultsOk() ([]AppUserView, bool) {
	if o == nil || IsNil(o.Results) {
		return nil, false
	}
...
func (o *PaginatedApiAppUserView) SetResults(v []AppUserView) {
	o.Results = v
}
...
func (o PaginatedApiAppUserView) ToMap() (map[string]interface{}, error) {
