...
// AtlasFTSAnalyzersViewManualTokenFiltersInner struct for AtlasFTSAnalyzersViewManualTokenFiltersInner
type AtlasFTSAnalyzersViewManualTokenFiltersInner struct {
...
func (dst *AtlasFTSAnalyzersViewManualTokenFiltersInner) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(AtlasFTSAnalyzersViewManualTokenFiltersInner)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *AtlasFTSAnalyzersViewManualTokenFiltersInner) MarshalJSON() ([]byte, error) {
...
type NullableAtlasFTSAnalyzersViewManualTokenFiltersInner struct {
	value *AtlasFTSAnalyzersViewManualTokenFiltersInner
	isSet bool
}

func (v NullableAtlasFTSAnalyzersViewManualTokenFiltersInner) Get() *AtlasFTSAnalyzersViewManualTokenFiltersInner {
	return v.value
}

func (v *NullableAtlasFTSAnalyzersViewManualTokenFiltersInner) Set(val *AtlasFTSAnalyzersViewManualTokenFiltersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAtlasFTSAnalyzersViewManualTokenFiltersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAtlasFTSAnalyzersViewManualTokenFiltersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAtlasFTSAnalyzersViewManualTokenFiltersInner(val *AtlasFTSAnalyzersViewManualTokenFiltersInner) *NullableAtlasFTSAnalyzersViewManualTokenFiltersInner {
	return &NullableAtlasFTSAnalyzersViewManualTokenFiltersInner{value: val, isSet: true}
}

func (v NullableAtlasFTSAnalyzersViewManualTokenFiltersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAtlasFTSAnalyzersViewManualTokenFiltersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
