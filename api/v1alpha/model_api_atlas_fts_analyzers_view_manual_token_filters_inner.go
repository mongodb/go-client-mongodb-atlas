...
// ApiAtlasFTSAnalyzersViewManualTokenFiltersInner struct for ApiAtlasFTSAnalyzersViewManualTokenFiltersInner
type ApiAtlasFTSAnalyzersViewManualTokenFiltersInner struct {
...
func (dst *ApiAtlasFTSAnalyzersViewManualTokenFiltersInner) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ApiAtlasFTSAnalyzersViewManualTokenFiltersInner)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src *ApiAtlasFTSAnalyzersViewManualTokenFiltersInner) MarshalJSON() ([]byte, error) {
...
type NullableApiAtlasFTSAnalyzersViewManualTokenFiltersInner struct {
	value *ApiAtlasFTSAnalyzersViewManualTokenFiltersInner
	isSet bool
}

func (v NullableApiAtlasFTSAnalyzersViewManualTokenFiltersInner) Get() *ApiAtlasFTSAnalyzersViewManualTokenFiltersInner {
	return v.value
}

func (v *NullableApiAtlasFTSAnalyzersViewManualTokenFiltersInner) Set(val *ApiAtlasFTSAnalyzersViewManualTokenFiltersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableApiAtlasFTSAnalyzersViewManualTokenFiltersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableApiAtlasFTSAnalyzersViewManualTokenFiltersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApiAtlasFTSAnalyzersViewManualTokenFiltersInner(val *ApiAtlasFTSAnalyzersViewManualTokenFiltersInner) *NullableApiAtlasFTSAnalyzersViewManualTokenFiltersInner {
	return &NullableApiAtlasFTSAnalyzersViewManualTokenFiltersInner{value: val, isSet: true}
}

func (v NullableApiAtlasFTSAnalyzersViewManualTokenFiltersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApiAtlasFTSAnalyzersViewManualTokenFiltersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
