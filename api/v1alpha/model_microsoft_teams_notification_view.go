...
// checks if the MicrosoftTeamsNotificationView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MicrosoftTeamsNotificationView{}
...
func (o MicrosoftTeamsNotificationView) ToMap() (map[string]interface{}, error) {
