...
func (r MultiCloudClustersApiCreateClusterRequest) Envelope(envelope bool) MultiCloudClustersApiCreateClusterRequest {
	r.envelope = &envelope
	return r
}
...
func (a *MultiCloudClustersApiService) CreateClusterExecute(r MultiCloudClustersApiCreateClusterRequest) (*ClusterDescriptionV15, *http.Response, error) {
	...
	localVarHTTPHeaderAccepts := []string{"application/vnd.atlas.2023-02-01+json", "application/vnd.atlas.unversioned+json"}
...
// Flag that indicates whether Application wraps the response in an &#x60;envelope&#x60; JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope&#x3D;true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.
func (r MultiCloudClustersApiGetClusterRequest) Envelope(envelope bool) MultiCloudClustersApiGetClusterRequest {
	r.envelope = &envelope
	return r
}
...
// Flag that indicates whether Application wraps the response in an &#x60;envelope&#x60; JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope&#x3D;true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.
func (r MultiCloudClustersApiListClustersRequest) Envelope(envelope bool) MultiCloudClustersApiListClustersRequest {
	r.envelope = &envelope
	return r
}
...
func (r MultiCloudClustersApiListClustersRequest) Execute() (*PaginatedClusterDescriptionV15View, *http.Response, error) {
...
// Execute executes the request
//  @return PaginatedClusterDescriptionV15View
func (a *MultiCloudClustersApiService) ListClustersExecute(r MultiCloudClustersApiListClustersRequest) (*PaginatedClusterDescriptionV15View, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
// Flag that indicates whether Application wraps the response in an &#x60;envelope&#x60; JSON object. Some API clients cannot access the HTTP response headers or status code. To remediate this, set envelope&#x3D;true in the query. Endpoints that return a list of results use the results object as an envelope. Application adds the status parameter to the response body.
func (r MultiCloudClustersApiUpdateClusterRequest) Envelope(envelope bool) MultiCloudClustersApiUpdateClusterRequest {
	r.envelope = &envelope
	return r
}
