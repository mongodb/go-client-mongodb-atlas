...
type LDAPConfigurationApi interface {
	...
	@return LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest
	*/
	RemoveOneCurrentLdapUserToDnMapping(ctx context.Context, groupId string) LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest

	// RemoveOneCurrentLdapUserToDnMappingExecute executes the request
	RemoveOneCurrentLdapUserToDnMappingExecute(r LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest) (*http.Response, error)
...
type LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest struct {
	ctx context.Context
...
func (r LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest) Envelope(envelope bool) LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest {
	r.envelope = &envelope
	return r
}

// Flag that indicates whether the response body should be in the &lt;a href&#x3D;\&quot;https://en.wikipedia.org/wiki/Prettyprint\&quot; target&#x3D;\&quot;_blank\&quot; rel&#x3D;\&quot;noopener noreferrer\&quot;&gt;prettyprint&lt;/a&gt; format.
func (r LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest) Pretty(pretty bool) LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest {
	r.pretty = &pretty
	return r
}

func (r LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest) Execute() (*http.Response, error) {
...
Removes the current LDAP Distinguished Name mapping captured in the ``userToDNMapping`` document from the LDAP configuration for the specified project. To use this resource, the requesting API Key must have the Project Atlas Admin role. This resource doesn't require the API Key to have an Access List.
 ...
 @return LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest
*/
func (a *LDAPConfigurationApiService) RemoveOneCurrentLdapUserToDnMapping(ctx context.Context, groupId string) LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest {
	return LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest{
		ApiService: a,
		ctx: ctx,
		groupId: groupId,
...
func (a *LDAPConfigurationApiService) RemoveOneCurrentLdapUserToDnMappingExecute(r LDAPConfigurationApiRemoveOneCurrentLdapUserToDnMappingRequest) (*http.Response, error) {
	var (
