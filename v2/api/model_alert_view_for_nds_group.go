...
type AlertViewForNdsGroup struct {
	...
	EventTypeName *ReplicaSetAlertableEventTypeForNdsGroup `json:"eventTypeName,omitempty"`
...
func (o *AlertViewForNdsGroup) GetEventTypeName() ReplicaSetAlertableEventTypeForNdsGroup {
	if o == nil || o.EventTypeName == nil {
		var ret ReplicaSetAlertableEventTypeForNdsGroup
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AlertViewForNdsGroup) GetEventTypeNameOk() (*ReplicaSetAlertableEventTypeForNdsGroup, bool) {
	if o == nil || o.EventTypeName == nil {
		return nil, false
	}
...
// SetEventTypeName gets a reference to the given ReplicaSetAlertableEventTypeForNdsGroup and assigns it to the EventTypeName field.
func (o *AlertViewForNdsGroup) SetEventTypeName(v ReplicaSetAlertableEventTypeForNdsGroup) {
	o.EventTypeName = &v
}
