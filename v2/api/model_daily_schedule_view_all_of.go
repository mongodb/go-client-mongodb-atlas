...
// DailyScheduleViewAllOf struct for DailyScheduleViewAllOf
type DailyScheduleViewAllOf struct {
...
func (o DailyScheduleViewAllOf) MarshalJSON() ([]byte, error) {
...
type NullableDailyScheduleViewAllOf struct {
	value *DailyScheduleViewAllOf
	isSet bool
}

func (v NullableDailyScheduleViewAllOf) Get() *DailyScheduleViewAllOf {
	return v.value
}

func (v *NullableDailyScheduleViewAllOf) Set(val *DailyScheduleViewAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableDailyScheduleViewAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableDailyScheduleViewAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDailyScheduleViewAllOf(val *DailyScheduleViewAllOf) *NullableDailyScheduleViewAllOf {
	return &NullableDailyScheduleViewAllOf{value: val, isSet: true}
}

func (v NullableDailyScheduleViewAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDailyScheduleViewAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
