...
type ClusterEventViewForNdsGroup struct {
	...
	EventTypeName ClusterEventTypeForNdsGroup `json:"eventTypeName"`
...
func (o *ClusterEventViewForNdsGroup) GetEventTypeName() ClusterEventTypeForNdsGroup {
	if o == nil {
		var ret ClusterEventTypeForNdsGroup
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ClusterEventViewForNdsGroup) GetEventTypeNameOk() (*ClusterEventTypeForNdsGroup, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ClusterEventViewForNdsGroup) SetEventTypeName(v ClusterEventTypeForNdsGroup) {
	o.EventTypeName = v
}
