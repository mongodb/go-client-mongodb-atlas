...
func (o *DataMetricAlertView) GetEventTypeName() HostMetricAlertableEventType {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *DataMetricAlertView) GetEventTypeNameOk() (*HostMetricAlertableEventType, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DataMetricAlertView) SetEventTypeName(v HostMetricAlertableEventType) {
	o.EventTypeName = v
}
